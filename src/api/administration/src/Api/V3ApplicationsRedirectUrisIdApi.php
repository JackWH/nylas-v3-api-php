<?php
/**
 * V3ApplicationsRedirectUrisIdApi
 * PHP version 8.1
 *
...
/**
 * V3ApplicationsRedirectUrisIdApi Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class V3ApplicationsRedirectUrisIdApi
{
    /**
     * @var ClientInterface
     */
    ...
    public function deleteACallbackURIRequest(
        ...
        $resourcePath = '/v3/applications/redirect-uris/{callback_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
