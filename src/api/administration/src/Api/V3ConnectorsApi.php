...
class V3ConnectorsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAConnector'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return object|object|object
     */
    public function createAConnector(
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
        string $contentType = self::contentTypes['createAConnector'][0]
    ): object {
        list($response) = $this->createAConnectorWithHttpInfo($content_type, $accept, $body, $contentType);

        return $response;
    }

    /**
     * Operation createAConnectorWithHttpInfo
     *
     * Create a connector
     *
     ...
     */
    public function createAConnectorWithHttpInfo(
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
        string $contentType = self::contentTypes['createAConnector'][0]
    ): array {
        $request = $this->createAConnectorRequest($content_type, $accept, $body, $contentType);
    ...
    /**
     * Operation createAConnectorAsync
     *
     * Create a connector
     *
     * @param  string|null $content_type (optional)
     ...
     */
    public function createAConnectorAsync(
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
        string $contentType = self::contentTypes['createAConnector'][0]
    ): PromiseInterface {
        return $this->createAConnectorAsyncWithHttpInfo($content_type, $accept, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createAConnectorAsyncWithHttpInfo
     *
     * Create a connector
     *
     * @param  string|null $content_type (optional)
     ...
     * @return PromiseInterface
     */
    public function createAConnectorAsyncWithHttpInfo(
        $content_type = null,
        $accept = null,
        $body = null,
        string $contentType = self::contentTypes['createAConnector'][0]
    ...
    /**
     * Create request for operation 'createAConnector'
     *
     * @param  string|null $content_type (optional)
     * @param  string|null $accept (optional)
     * @param  object|null $body (optional)
     ...
     */
    public function createAConnectorRequest(
        $content_type = null,
        $accept = null,
        $body = null,
        string $contentType = self::contentTypes['createAConnector'][0]
    ...
    public function listConnectors(
        ?string $accept = null,
        string $contentType = self::contentTypes['listConnectors'][0]
    ): object {
        list($response) = $this->listConnectorsWithHttpInfo($accept, $contentType);
     ...
     * @return array of object|object|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function listConnectorsWithHttpInfo(
        ?string $accept = null,
        string $contentType = self::contentTypes['listConnectors'][0]
    ): array {
        $request = $this->listConnectorsRequest($accept, $contentType);
     ...
     * @return PromiseInterface
     */
    public function listConnectorsAsync(
        ?string $accept = null,
        string $contentType = self::contentTypes['listConnectors'][0]
    ): PromiseInterface {
        return $this->listConnectorsAsyncWithHttpInfo($accept, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function listConnectorsAsyncWithHttpInfo(
        $accept = null,
        string $contentType = self::contentTypes['listConnectors'][0]
    ): PromiseInterface {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listConnectorsRequest(
        $accept = null,
        string $contentType = self::contentTypes['listConnectors'][0]
    ): Request {
