<?php
/**
 * AddApplicationRedirectUri200Response
 *
 * PHP version 8.1
 *
 ...
 */
class AddApplicationRedirectUri200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'add_application_redirect_uri_200_response';
    ...
    */
     ...
     * Sets data
     *
     * @param OneOf|null $data data
     *
     * @return $this
     */
    public function setData(?OneOf $data): static
    {
        if (is_null($data)) {
