...
/**
 * AndroidCallbackwSettings Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AndroidCallbackwSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AndroidCallbackwSettings';
    ...
    protected static array $openAPITypes = [
        ...
        'id' => 'string',
        'url' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\AndroidCallbackwSettingsSettings',
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Callback URI ID - UUID
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string|null $url Callback URL. This can be https, or a deeplink `<package/bundle-name>://<deeplink>`. Http is only allowed for localhost development, otherwise you must use https.
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\AndroidCallbackwSettingsSettings|null
     */
    public function getSettings(): ?\JackWH\NylasV3\Administration\Model\AndroidCallbackwSettingsSettings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\AndroidCallbackwSettingsSettings|null $settings settings
     *
     * @return $this
     */
    public function setSettings(?\JackWH\NylasV3\Administration\Model\AndroidCallbackwSettingsSettings $settings): static
    {
        if (is_null($settings)) {
