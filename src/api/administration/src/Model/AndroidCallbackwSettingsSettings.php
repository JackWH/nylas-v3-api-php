<?php
/**
 * AndroidCallbackwSettingsSettings
 *
 * PHP version 8.1
 *
 ...
 */
class AndroidCallbackwSettingsSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AndroidCallbackwSettings_settings';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sha1_certificate_fingerprint', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets package_name
     *
     * @param string $package_name Find your app's Package Name in the Android Manifest. It's a unique identifier that distinguishes your app on the Google Play Store and on the device. It follows a reverse domain name notation, such as `com.example.myapp`.
     *
     * @return $this
     */
    ...
    /**
     * Gets sha1_certificate_fingerprint
     *
     * @return string
     */
    public function getSha1CertificateFingerprint(): string
    {
        return $this->container['sha1_certificate_fingerprint'];
    }

    /**
     * Sets sha1_certificate_fingerprint
     *
     * @param string $sha1_certificate_fingerprint A SHA-1 hash of the app's signing certificate. This ensures that only the _signed_ version of your app can use the redirect URI.
     *
     * @return $this
     */
    public function setSha1CertificateFingerprint(string $sha1_certificate_fingerprint): static
    {
        if (is_null($sha1_certificate_fingerprint)) {
            throw new InvalidArgumentException('non-nullable sha1_certificate_fingerprint cannot be null');
        }
        $this->container['sha1_certificate_fingerprint'] = $sha1_certificate_fingerprint;
