...
/**
 * ConnectorOverride Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ConnectorOverride implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Connector_Override';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the credential. Must be unique.
     *
     * @return $this
     */
     ...
     * @return object
     */
    public function getCredentialData(): object
    {
     ...
     *
     * @param object $credential_data An object that contains special information that must be included in the credential. This information is securely encrypted and stored, and is _not_ visible to end users. </br></br> You must include data such as the `client_id` and `client_secret` for the provider auth application.
     *
     * @return $this
     */
    public function setCredentialData(object $credential_data): static
    {
