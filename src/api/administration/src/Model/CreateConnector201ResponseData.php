<?php
/**
 * CreateConnector201ResponseData
 *
 * PHP version 8.1
 *
...
/**
 * CreateConnector201ResponseData Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateConnector201ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_connector_201_response_data';
    ...
    */
     ...
     * Sets settings
     *
     * @param object|null $settings Optional settings from provider
     *
     * @return $this
     */
    public function setSettings(?object $settings): static
    {
        if (is_null($settings)) {
     ...
     * Sets scope
     *
     * @param string[]|null $scope (Not used for Zoom connectors.) Optional default scopes for the connector.
     *
     * @return $this
     */
