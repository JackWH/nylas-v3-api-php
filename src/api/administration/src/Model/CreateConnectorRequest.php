 ...
 */
class CreateConnectorRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_connector_request';
    ...
    public const SCOPES_MESSAGES = 'ews.messages';
    public const SCOPES_CALENDAR = 'ews.calendar';
    public const SCOPES_CONTACTS = 'ews.contacts';
    ...
    {
        return [
            self::SCOPES_MESSAGES,
            self::SCOPES_CALENDAR,
            self::SCOPES_CONTACTS,
        ];
    }
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The provider type. For Yahoo providers, set to `yahoo`.
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\YahooSettings
     */
    public function getSettings(): \JackWH\NylasV3\Administration\Model\YahooSettings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\YahooSettings $settings settings
     *
     * @return $this
     */
    public function setSettings(\JackWH\NylasV3\Administration\Model\YahooSettings $settings): static
    {
        if (is_null($settings)) {
     ...
     * Sets scope
     *
     * @param string[]|null $scope Set the default scopes for each connector. These scopes are overridden by scopes set on the specific grant.
     *
     * @return $this
     */
     ...
     * Sets scopes
     *
     * @param string|null $scopes Scopes settings tell Nylas to request specific data objects from the provider.
     *
     * @return $this
     */
