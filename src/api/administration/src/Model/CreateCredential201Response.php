...
/**
 * CreateCredential201Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateCredential201Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_credential_201_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'data' => '\JackWH\NylasV3\Administration\Model\GetCredentialAll200ResponseDataInner',
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\Administration\Model\GetCredentialAll200ResponseDataInner|null
     */
    public function getData(): ?\JackWH\NylasV3\Administration\Model\GetCredentialAll200ResponseDataInner
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\Administration\Model\GetCredentialAll200ResponseDataInner|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\Administration\Model\GetCredentialAll200ResponseDataInner $data): static
    {
        if (is_null($data)) {
