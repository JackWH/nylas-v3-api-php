<?php
/**
 * CreatePubsubChannel200ResponseData
 *
 * PHP version 8.1
 *
 ...
 */
class CreatePubsubChannel200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_pubsub_channel_200_response_data';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id A unique identifier for the Pub/Sub notification channel.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description A human-readable description of the Pub/Sub notification channel.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the Pub/Sub channel. When you first create a new channel, Nylas sets it to \"active\".
     *
     * @return $this
     */
