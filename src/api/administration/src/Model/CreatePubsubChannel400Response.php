<?php
/**
 * CreatePubsubChannel400Response
 *
 * PHP version 8.1
 *
...
/**
 * CreatePubsubChannel400Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreatePubsubChannel400Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_pubsub_channel_400_response';
    ...
    protected static array $openAPITypes = [
        'error' => '\JackWH\NylasV3\Administration\Model\CreatePubsubChannel400ResponseError',
        'request_id' => 'string'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\Administration\Model\CreatePubsubChannel400ResponseError|null
     */
    public function getError(): ?\JackWH\NylasV3\Administration\Model\CreatePubsubChannel400ResponseError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\Administration\Model\CreatePubsubChannel400ResponseError|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\Administration\Model\CreatePubsubChannel400ResponseError $error): static
    {
        if (is_null($error)) {
     ...
     * Sets request_id
     *
     * @param string|null $request_id The unique ID of the request that generated this response.
     *
     * @return $this
     */
