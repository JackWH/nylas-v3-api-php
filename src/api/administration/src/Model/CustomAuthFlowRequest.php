...
/**
 * CustomAuthFlowRequest Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomAuthFlowRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request';
    ...
    protected static array $openAPITypes = [
        'provider' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf8Settings',
        'scope' => 'string[]',
        'state' => 'string',
    ];
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider Zoom Meetings
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf8Settings
     */
    public function getSettings(): \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf8Settings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf8Settings $settings settings
     *
     * @return $this
     */
    public function setSettings(\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf8Settings $settings): static
    {
        if (is_null($settings)) {
     ...
     * Sets scope
     *
     * @param string[]|null $scope The scopes defined for this grant.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string|null $state Optional state value to return to your project when the auth flow completes. If you include the `state`, Nylas returns the unmodified value to the application. You can use this for verification, or to track information about the user.  Learn more about the `state` parameter in the [OAuth 2.0 specification](https://datatracker.ietf.org/doc/html/rfc6749) or the [official OAuth 2.0 documentation](https://www.oauth.com/oauth2-servers/authorization/the-authorization-request/).
     *
     * @return $this
     */
