...
/**
 * CustomAuthFlowRequestOneOf1 Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_1';
    ...
    protected static array $openAPITypes = [
        'provider' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf1Settings'
    ];
    ...
    */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf1Settings
     */
    public function getSettings(): \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf1Settings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf1Settings $settings settings
     *
     * @return $this
     */
    public function setSettings(\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf1Settings $settings): static
    {
        if (is_null($settings)) {
