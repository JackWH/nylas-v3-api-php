<?php
/**
 * CustomAuthFlowRequestOneOf1Settings
 *
 * PHP version 8.1
 *
 ...
 *
 * @description A list of settings required by the provider, including the &#x60;refresh_token&#x60;. If you add the &#x60;credential_id&#x60; attribute with the UUID of an existing [credential record](/docs/api/v3/admin/#post-/v3/connectors/-provider-/creds), Nylas uses the provider&#39;s &#x60;client_id&#x60; and &#x60;client_secret&#x60; from the credential record. If the credential data is missing or invalid, Nylas falls back and uses the connector&#39;s default values.
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class CustomAuthFlowRequestOneOf1Settings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_1_settings';
    ...
    */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token The refresh token associated with the email account.
     *
     * @return $this
     */
     ...
     * Sets credential_id
     *
     * @param string|null $credential_id The ID of an existing connector credential that Nylas can use to override default connector settings. When you specify a credential ID, it overrides the default connector settings for the provider.
     *
     * @return $this
     */
