...
/**
 * CustomAuthFlowRequestOneOf2 Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf2 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_2';
    ...
    protected static array $openAPITypes = [
        'provider' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf2Settings',
    ];
    ...
    */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf2Settings
     */
    public function getSettings(): \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf2Settings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf2Settings $settings settings
     *
     * @return $this
     */
    public function setSettings(\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf2Settings $settings): static
    {
        if (is_null($settings)) {
