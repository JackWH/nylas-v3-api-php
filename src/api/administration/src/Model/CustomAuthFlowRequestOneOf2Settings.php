<?php
/**
 * CustomAuthFlowRequestOneOf2Settings
 *
 * PHP version 8.1
 *
...
/**
 * CustomAuthFlowRequestOneOf2Settings Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf2Settings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_2_settings';
    ...
    */
     ...
     * Sets credential_id
     *
     * @param string|null $credential_id The ID of an existing `adminconsent` credential that can be used to authenticate Microsoft App Permission grants.
     *
     * @return $this
     */
