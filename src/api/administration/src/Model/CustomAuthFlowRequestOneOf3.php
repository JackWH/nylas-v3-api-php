...
/**
 * CustomAuthFlowRequestOneOf3 Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf3 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_3';
    ...
    protected static array $openAPITypes = [
        'provider' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf3Settings'
    ];
    ...
    */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf3Settings
     */
    public function getSettings(): \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf3Settings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf3Settings $settings settings
     *
     * @return $this
     */
    public function setSettings(\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf3Settings $settings): static
    {
        if (is_null($settings)) {
