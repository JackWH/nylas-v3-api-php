<?php
/**
 * CustomAuthFlowRequestOneOf3Settings
 *
 * PHP version 8.1
 *
 ...
 */
class CustomAuthFlowRequestOneOf3Settings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_3_settings';
    ...
    */
     ...
     * Sets email_address
     *
     * @param string|null $email_address The end user's email address.
     *
     * @return $this
     */
     ...
     * Sets credential_id
     *
     * @param string|null $credential_id The ID of an existing `serviceaccount` credential that can be used to authenticate Google workspace service account grants.
     *
     * @return $this
     */
     ...
     * Sets scopes
     *
     * @param string[]|null $scopes The scopes defined for this generated grant.
     *
     * @return $this
     */
