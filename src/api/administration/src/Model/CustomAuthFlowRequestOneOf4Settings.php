<?php
/**
 * CustomAuthFlowRequestOneOf4Settings
 *
 * PHP version 8.1
 *
...
/**
 * CustomAuthFlowRequestOneOf4Settings Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf4Settings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_4_settings';
    ...
    */
     ...
     * Sets imap_username
     *
     * @param string|null $imap_username The end user's email address.
     *
     * @return $this
     */
     ...
     * Sets imap_password
     *
     * @param string|null $imap_password The end user's email account password or app password.
     *
     * @return $this
     */
     ...
     * Sets imap_host
     *
     * @param string|null $imap_host (Optional) The IMAP host. If you don't define the host in the request payload, Nylas tries to auto-detect the hostname using the `imap_username`. If you're using a self-hosted IMAP server, you must provide the hostname.
     *
     * @return $this
     */
     ...
     * Sets imap_port
     *
     * @param int|null $imap_port (Optional) The IMAP port. If you don't define the port in the request payload, Nylas tries to auto-detect the port using the `imap_username`. If you're using a self-hosted IMAP server, you must provide the port number.
     *
     * @return $this
     */
     ...
     * Sets smtp_host
     *
     * @param string|null $smtp_host (Optional) The SMTP host. If you don't define the host in the request payload, Nylas tries to auto-detect the hostname using the `imap_username`. If you're using a self-hosted SMTP server, you must provide the host name.
     *
     * @return $this
     */
     ...
     * Sets smtp_port
     *
     * @param int|null $smtp_port (Optional) The SMTP port. If you don't define the port in the request payload, Nylas tries to auto-detect the port using the `imap_username`. If you're using a self-hosted SMTP server, you must provide the port number.
     *
     * @return $this
     */
