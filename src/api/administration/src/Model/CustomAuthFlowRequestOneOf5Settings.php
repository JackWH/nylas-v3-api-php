<?php
/**
 * CustomAuthFlowRequestOneOf5Settings
 *
 * PHP version 8.1
 *
...
/**
 * CustomAuthFlowRequestOneOf5Settings Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf5Settings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_5_settings';
    ...
    */
     ...
     * Sets username
     *
     * @param string|null $username The end user's iCloud email address.
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string|null $password The end user's app password.
     *
     * @return $this
     */
