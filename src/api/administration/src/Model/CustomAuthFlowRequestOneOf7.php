...
/**
 * CustomAuthFlowRequestOneOf7 Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf7 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_7';
    ...
    protected static array $openAPITypes = [
        'provider' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf7Settings',
        'state' => 'string',
    ];
    ...
    */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf7Settings
     */
    public function getSettings(): \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf7Settings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf7Settings $settings settings
     *
     * @return $this
     */
    public function setSettings(\JackWH\NylasV3\Administration\Model\CustomAuthFlowRequestOneOf7Settings $settings): static
    {
        if (is_null($settings)) {
