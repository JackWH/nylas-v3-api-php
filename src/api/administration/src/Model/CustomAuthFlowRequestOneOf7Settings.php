<?php
/**
 * CustomAuthFlowRequestOneOf7Settings
 *
 * PHP version 8.1
 *
...
/**
 * CustomAuthFlowRequestOneOf7Settings Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf7Settings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_7_settings';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email The email address associated with the virtual account. This can be any arbitrary identifier. It does not need to be a real email address.
     *
     * @return $this
     */
