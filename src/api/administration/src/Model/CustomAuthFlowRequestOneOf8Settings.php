<?php
/**
 * CustomAuthFlowRequestOneOf8Settings
 *
 * PHP version 8.1
 *
...
/**
 * CustomAuthFlowRequestOneOf8Settings Class Doc Comment
 *
 ...
 */
class CustomAuthFlowRequestOneOf8Settings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_8_settings';
    ...
    */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token The refresh_token from Zoom code exchange.
     *
     * @return $this
     */
