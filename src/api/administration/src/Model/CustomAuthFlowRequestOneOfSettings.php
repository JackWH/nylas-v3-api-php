<?php
/**
 * CustomAuthFlowRequestOneOfSettings
 *
 * PHP version 8.1
 *
 ...
 */
class CustomAuthFlowRequestOneOfSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'custom_auth_flow_request_oneOf_settings';
