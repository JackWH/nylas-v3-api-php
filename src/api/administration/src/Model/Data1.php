 ...
 */
class Data1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'data_1';
    ...
    */
     ...
     * Sets error
     *
     * @param string|null $error Error type constant.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $error_description A human-readable error description.
     *
     * @return $this
     */
     ...
     * Sets error_uri
     *
     * @param string|null $error_uri A URL to the related documentation and troubleshooting regarding this error.
     *
     * @return $this
     */
     ...
     * Sets error_code
     *
     * @param string|null $error_code Error code used for referencing the documentation, logs, and data stream.
     *
     * @return $this
     */
