 ...
 */
class DestinationUpdatePayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Destination_Update_Payload';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The new status of the destination.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $notification_email_addresses The email addresses that Nylas notifies when a webhook is down for a while. See the [rate limit documentation](/docs/dev-guide/best-practices/rate-limits/) for details.
     *
     * @return $this
     */
