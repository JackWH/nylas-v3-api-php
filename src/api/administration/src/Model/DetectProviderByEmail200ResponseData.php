<?php
/**
 * DetectProviderByEmail200ResponseData
 *
 * PHP version 8.1
 *
...
/**
 * DetectProviderByEmail200ResponseData Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DetectProviderByEmail200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'detect_provider_by_email_200_response_data';
    ...
    */
     ...
     * Sets provider
     *
     * @param string|null $provider Provider detected.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type Provider type. Returned only when IMAP detected displays the IMAP provider.
     *
     * @return $this
     */
     ...
     * Sets email_address
     *
     * @param string $email_address Email provided for autodetection.
     *
     * @return $this
     */
     ...
     * @return bool
     */
    public function getDetected(): bool
    {
     ...
     * Sets detected
     *
     * @param bool $detected Whether Nylas detected a provider for the given email address.
     *
     * @return $this
     */
    public function setDetected(bool $detected): static
    {
        if (is_null($detected)) {
