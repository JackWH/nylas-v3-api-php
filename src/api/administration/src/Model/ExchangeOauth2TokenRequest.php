 ...
 */
class ExchangeOauth2TokenRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'exchange_oauth2_token_request';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string $client_id Your Nylas application's client ID.
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret Your Nylas application's API key.
     *
     * @return $this
     */
     ...
     * Sets grant_type
     *
     * @param string $grant_type Supports exchanging a `code` for a token, or refreshing an access token using a `refresh_token`.
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param string $code The `code` from the OAuth 2.0 authorization flow.
     *
     * @return $this
     */
     ...
     * Sets redirect_uri
     *
     * @param string $redirect_uri The URL that Nylas redirects the end user to after the authentication flow. This should match the `callback_uri` or `redirect_uri` that you used to get the `code` during the initial [authorization request](/docs/api/v3/admin/#get-/v3/connect/auth).
     *
     * @return $this
     */
     ...
     * Sets code_verifier
     *
     * @param string|null $code_verifier The plaintext `code` verifier (`code_challenge`) that you created in the [authorization request](/docs/api/v3/admin/#get-/v3/connect/auth).
     *
     * @return $this
     */
    public function setCodeVerifier(?string $code_verifier): static
    {
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token Required to refresh or request a short-lived access token.
     *
     * @return $this
     */
