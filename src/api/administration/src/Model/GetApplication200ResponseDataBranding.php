<?php
/**
 * GetApplication200ResponseDataBranding
 *
 * PHP version 8.1
 *
 ...
 */
class GetApplication200ResponseDataBranding implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_application_200_response_data_branding';
    ...
    */
     ...
     * Sets icon_url
     *
     * @param string|null $icon_url URL points to application icon.
     *
     * @return $this
     */
     ...
     * Sets website_url
     *
     * @param string|null $website_url Application / publisher website URL
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the application.
     *
     * @return $this
     */
