...
/**
 * GetApplication400Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetApplication400Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_application_400_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\Administration\Model\GetApplication400ResponseError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\Administration\Model\GetApplication400ResponseError
     */
    public function getError(): \JackWH\NylasV3\Administration\Model\GetApplication400ResponseError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\Administration\Model\GetApplication400ResponseError $error error
     *
     * @return $this
     */
    public function setError(\JackWH\NylasV3\Administration\Model\GetApplication400ResponseError $error): static
    {
        if (is_null($error)) {
