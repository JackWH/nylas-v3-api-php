...
/**
 * GetApplication401Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetApplication401Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_application_401_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\Administration\Model\GetApplication401ResponseError',
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\Administration\Model\GetApplication401ResponseError
     */
    public function getError(): \JackWH\NylasV3\Administration\Model\GetApplication401ResponseError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\Administration\Model\GetApplication401ResponseError $error error
     *
     * @return $this
     */
    public function setError(\JackWH\NylasV3\Administration\Model\GetApplication401ResponseError $error): static
    {
        if (is_null($error)) {
