<?php
/**
 * GetConnectorByProvider200Response
 *
 * PHP version 8.1
 *
...
/**
 * GetConnectorByProvider200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetConnectorByProvider200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_connector_by_provider_200_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'data' => '\JackWH\NylasV3\Administration\Model\CreateConnector201ResponseData',
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\Administration\Model\CreateConnector201ResponseData|null
     */
    public function getData(): ?\JackWH\NylasV3\Administration\Model\CreateConnector201ResponseData
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\Administration\Model\CreateConnector201ResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\Administration\Model\CreateConnector201ResponseData $data): static
    {
        if (is_null($data)) {
