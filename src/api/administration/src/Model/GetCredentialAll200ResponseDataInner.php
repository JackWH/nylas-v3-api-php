<?php
/**
 * GetCredentialAll200ResponseDataInner
 *
 * PHP version 8.1
 *
 ...
 */
class GetCredentialAll200ResponseDataInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_credential_all_200_response_data_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Unique name of this credential
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param int $created_at Date of creation of the credential
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param int $updated_at Initially same as `created_at`. Can differ if the credential has been updated.
     *
     * @return $this
     */
