...
/**
 * GetGrantById200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetGrantById200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_grant_by_id_200_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'data' => '\JackWH\NylasV3\Administration\Model\GetGrantAll200ResponseDataInner',
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\Administration\Model\GetGrantAll200ResponseDataInner|null
     */
    public function getData(): ?\JackWH\NylasV3\Administration\Model\GetGrantAll200ResponseDataInner
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\Administration\Model\GetGrantAll200ResponseDataInner|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\Administration\Model\GetGrantAll200ResponseDataInner $data): static
    {
        if (is_null($data)) {
