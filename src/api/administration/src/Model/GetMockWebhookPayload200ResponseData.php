<?php
/**
 * GetMockWebhookPayload200ResponseData
 *
 * PHP version 8.1
 *
 ...
 */
class GetMockWebhookPayload200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_mock_webhook_payload_200_response_data';
    ...
    */
     ...
     * Sets data
     *
     * @param object|null $data This object is an example payload that Nylas sends to your webhook destination
     *
     * @return $this
     */
