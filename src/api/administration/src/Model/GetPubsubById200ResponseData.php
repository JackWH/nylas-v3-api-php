...
/**
 * GetPubsubById200ResponseData Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetPubsubById200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_pubsub_by_id_200_response_data';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id A unique identifier for the Pub/Sub channel.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description A human-readable description of the Pub/Sub channel.
     *
     * @return $this
     */
     ...
     * Sets topic
     *
     * @param string|null $topic The Google Pub/Sub topic that Nylas sends notifications to.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The deliverability status of the Pub/Sub channel.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $notification_email_addresses The email addresses that Nylas notifies if delivery to the Pub/Sub channel fails. See the [Webhooks documentation](/docs/v3/notifications/webhooks/#failed-and-failing-webhooks) for details.
     *
     * @return $this
     */
     ...
     * @return int|null
     */
    public function getStatusUpdatedAt(): ?int
    {
     ...
     *
     * @param int|null $status_updated_at The time the `status` field was last updated, represented as a Unix timestamp in seconds.
     *
     * @return $this
     */
    public function setStatusUpdatedAt(?int $status_updated_at): static
    {
     ...
     * Sets created_at
     *
     * @param int|null $created_at The time the Pub/Sub channel was created, represented as a Unix timestamp in seconds.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param int|null $updated_at The time the Pub/Sub channel was last updated, represented as a Unix timestamp in seconds.
     *
     * @return $this
     */
