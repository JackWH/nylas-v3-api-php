<?php
/**
 * GetPubsubChannels400ResponseError
 *
 * PHP version 8.1
 *
...
/**
 * GetPubsubChannels400ResponseError Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetPubsubChannels400ResponseError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_pubsub_channels_400_response_error';
