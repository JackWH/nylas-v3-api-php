...
/**
 * GetWebhookById200ResponseData Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetWebhookById200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_webhook_by_id_200_response_data';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id A unique identifier for the webhook destination.
     *
     * @return $this
     */
     ...
     * Sets webhook_url
     *
     * @param string|null $webhook_url The URL to send webhooks to.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the new destination.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $notification_email_addresses The email addresses that Nylas notifies when a webhook is down for a while. See the [Webhooks documentation](/docs/v3/notifications/webhooks/#failed-and-failing-webhooks) for details.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param int|null $created_at The time the webhook destination was created, represented as a Unix timestamp in seconds.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param int|null $updated_at The time the webhook destination was last updated, represented as a Unix timestamp in seconds.
     *
     * @return $this
     */
