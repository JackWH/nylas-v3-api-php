<?php
/**
 * GetWebhookDestinationsApplication400Response
 *
 * PHP version 8.1
 *
...
/**
 * GetWebhookDestinationsApplication400Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetWebhookDestinationsApplication400Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_webhook_destinations_application_400_response';
    ...
    protected static array $openAPITypes = [
        'error' => '\JackWH\NylasV3\Administration\Model\GetWebhookDestinationsApplication400ResponseError',
        'request_id' => 'string'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\Administration\Model\GetWebhookDestinationsApplication400ResponseError|null
     */
    public function getError(): ?\JackWH\NylasV3\Administration\Model\GetWebhookDestinationsApplication400ResponseError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\Administration\Model\GetWebhookDestinationsApplication400ResponseError|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\Administration\Model\GetWebhookDestinationsApplication400ResponseError $error): static
    {
        if (is_null($error)) {
