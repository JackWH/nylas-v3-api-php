 ...
 */
class Google implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Google';
    ...
    protected static array $openAPITypes = [
        'provider' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\GoogleSettings',
        'scope' => 'string[]'
    ];
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The provider type. For Google providers, set to `google`.
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\GoogleSettings|null
     */
    public function getSettings(): ?\JackWH\NylasV3\Administration\Model\GoogleSettings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\GoogleSettings|null $settings settings
     *
     * @return $this
     */
    public function setSettings(?\JackWH\NylasV3\Administration\Model\GoogleSettings $settings): static
    {
        if (is_null($settings)) {
