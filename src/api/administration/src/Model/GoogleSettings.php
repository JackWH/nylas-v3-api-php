 ...
 */
class GoogleSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Google_settings';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string $client_id The GCP app's client ID.
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret The GCP app's client secret.
     *
     * @return $this
     */
     ...
     * Sets topic_name
     *
     * @param string|null $topic_name Google Pub/Sub topic name. Required if using Email webhooks.
     *
     * @return $this
     */
