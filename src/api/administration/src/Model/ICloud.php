 ...
 */
class ICloud implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'iCloud';
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The provider type. For iCloud providers, set to `icloud`.
     *
     * @return $this
     */
