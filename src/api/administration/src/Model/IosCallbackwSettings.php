 ...
 */
class IosCallbackwSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'iosCallbackwSettings';
    ...
    */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\IosCallbackwSettingsSettings|null
     */
    public function getSettings(): ?\JackWH\NylasV3\Administration\Model\IosCallbackwSettingsSettings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\IosCallbackwSettingsSettings|null $settings settings
     *
     * @return $this
     */
    public function setSettings(?\JackWH\NylasV3\Administration\Model\IosCallbackwSettingsSettings $settings): static
    {
        if (is_null($settings)) {
