 ...
 */
class IosCallbackwSettingsSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'iosCallbackwSettings_settings';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('app_store_id', $data ?? [], null);
    ...
    */
     ...
     * Sets bundle_id
     *
     * @param string $bundle_id The `bundle_id` (Bundle Identifier) is a unique identifier for an iOS app. It's set in the Xcode project and follows a reverse domain name style.
     *
     * @return $this
     */
    public function setBundleId(string $bundle_id): static
    {
     ...
     * @return string|null
     */
    public function getAppStoreId(): ?string
    {
     ...
     * Sets app_store_id
     *
     * @param string|null $app_store_id Unique identifier for your app on the Apple App Store. This ID is assigned to your app when you submit it to the App Store and it is approved.
     *
     * @return $this
     */
    public function setAppStoreId(?string $app_store_id): static
    {
        if (is_null($app_store_id)) {
            throw new InvalidArgumentException('non-nullable app_store_id cannot be null');
        }
     ...
     * Sets team_id
     *
     * @param string|null $team_id Unique identifier for your Apple Developer Account or team.
     *
     * @return $this
     */
