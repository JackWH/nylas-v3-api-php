...
/**
 * JsCallbackwSettings Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class JsCallbackwSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'JsCallbackwSettings';
    ...
    protected static array $openAPITypes = [
        ...
        'id' => 'string',
        'url' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\JsCallbackwSettingsSettings',
    ];
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Callback URL, including the protocol. This must be https, unless using http for localhost development.
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\JsCallbackwSettingsSettings|null
     */
    public function getSettings(): ?\JackWH\NylasV3\Administration\Model\JsCallbackwSettingsSettings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\JsCallbackwSettingsSettings|null $settings settings
     *
     * @return $this
     */
    public function setSettings(?\JackWH\NylasV3\Administration\Model\JsCallbackwSettingsSettings $settings): static
    {
        if (is_null($settings)) {
