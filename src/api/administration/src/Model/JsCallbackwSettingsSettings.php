...
/**
 * JsCallbackwSettingsSettings Class Doc Comment
 *
 ...
 */
class JsCallbackwSettingsSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'JsCallbackwSettings_settings';
    ...
    */
     ...
     * Sets origin
     *
     * @param string $origin Th `origin` is the base URL from which your project or app is served. It is required because it's a critical part of defining your app's trust boundaries to prevent cross-origin issues. Set this when you set up OAuth redirect URIs and other security settings.
     *
     * @return $this
     */
