 ...
 */
class Microsoft implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Microsoft';
    ...
    protected static array $openAPITypes = [
        'provider' => 'string',
        'settings' => '\JackWH\NylasV3\Administration\Model\MicrosoftSettings',
        'scope' => 'string[]',
    ];
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The provider type. For Microsoft providers, set to `microsoft`.
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\MicrosoftSettings|null
     */
    public function getSettings(): ?\JackWH\NylasV3\Administration\Model\MicrosoftSettings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\MicrosoftSettings|null $settings settings
     *
     * @return $this
     */
    public function setSettings(?\JackWH\NylasV3\Administration\Model\MicrosoftSettings $settings): static
    {
        if (is_null($settings)) {
