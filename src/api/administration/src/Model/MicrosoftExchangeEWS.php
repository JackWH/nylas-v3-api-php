 ...
 */
class MicrosoftExchangeEWS implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Microsoft_Exchange__EWS_';
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The provider type (in this case, `ews`).
     *
     * @return $this
     */
