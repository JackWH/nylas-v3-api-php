...
/**
 * MicrosoftSettings Class Doc Comment
 *
 ...
 */
class MicrosoftSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Microsoft_settings';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string $client_id The Azure auth app's client ID.
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret The Azure auth app's client secret.
     *
     * @return $this
     */
     ...
     * Sets tenant
     *
     * @param string|null $tenant Microsoft tenant ID.
     *
     * @return $this
     */
