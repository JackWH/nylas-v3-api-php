 ...
 */
class PatchGrantByIdRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'patch_grant_by_id_request';
    ...
    */
     ...
     * Sets settings
     *
     * @param object|null $settings Settings required by provider
     *
     * @return $this
     */
