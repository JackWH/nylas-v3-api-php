...
/**
 * PostNewSecret200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostNewSecret200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_new_secret_200_response';
    ...
    protected static array $openAPITypes = [
        'data' => '\JackWH\NylasV3\Administration\Model\PostNewSecret200ResponseData',
        'request_id' => 'string',
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\Administration\Model\PostNewSecret200ResponseData|null
     */
    public function getData(): ?\JackWH\NylasV3\Administration\Model\PostNewSecret200ResponseData
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\Administration\Model\PostNewSecret200ResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\Administration\Model\PostNewSecret200ResponseData $data): static
    {
        if (is_null($data)) {
