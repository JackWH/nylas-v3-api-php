<?php
/**
 * PostWebhookDestinations200Response
 *
 * PHP version 8.1
 *
...
/**
 * PostWebhookDestinations200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostWebhookDestinations200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_webhook_destinations_200_response';
    ...
    protected static array $openAPITypes = [
        'data' => '\JackWH\NylasV3\Administration\Model\PostWebhookDestinations200ResponseData',
        'request_id' => 'string',
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\Administration\Model\PostWebhookDestinations200ResponseData|null
     */
    public function getData(): ?\JackWH\NylasV3\Administration\Model\PostWebhookDestinations200ResponseData
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\Administration\Model\PostWebhookDestinations200ResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\Administration\Model\PostWebhookDestinations200ResponseData $data): static
    {
        if (is_null($data)) {
     ...
     * Sets request_id
     *
     * @param string|null $request_id The request ID for each request.
     *
     * @return $this
     */
