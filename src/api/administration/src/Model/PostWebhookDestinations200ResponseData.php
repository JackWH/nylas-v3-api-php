<?php
/**
 * PostWebhookDestinations200ResponseData
 *
 * PHP version 8.1
 *
 ...
 */
class PostWebhookDestinations200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_webhook_destinations_200_response_data';
    ...
    */
     ...
     * Sets webhook_secret
     *
     * @param string|null $webhook_secret A secret value used to encode the `X-Nylas-Signature` header on webhook requests.
     *
     * @return $this
     */
    public function setWebhookSecret(?string $webhook_secret): static
    {
     ...
     * Sets status
     *
     * @param string|null $status The status of the new destination. This will always be \"active\" if Nylas successfully created the destination. If you need to pause the destination, use the [Update webhook destination](#put-/v3/webhooks/-id-) method to change the status to `pause`.
     *
     * @return $this
     */
