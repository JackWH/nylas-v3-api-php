...
/**
 * PutPubsubById200ResponseData Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PutPubsubById200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'put_pubsub_by_id_200_response_data';
    ...
    */
     ...
     *
     * @param string[]|null $notification_email_addresses The email addresses that Nylas notifies if delivery to the Pub/Sub channel fails. See the [webhook documentation](/docs/v3/notifications/webhooks/#failed-and-failing-webhooks) for details.
     *
     * @return $this
     */
