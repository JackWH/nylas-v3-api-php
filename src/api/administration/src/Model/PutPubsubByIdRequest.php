...
/**
 * PutPubsubByIdRequest Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PutPubsubByIdRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'put_pubsub_by_id_request';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The new status of the channel. Use this to restart a channel that you manually paused, or that was automatically paused due to deliverability issues.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $notification_email_addresses The email addresses that Nylas notifies if there are errors or deliverability problems. See the [rate limit documentation](/docs/dev-guide/best-practices/rate-limits/) for details.
     *
     * @return $this
     */
