 ...
 */
class PutWebhookById200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'put_webhook_by_id_200_response_data';
