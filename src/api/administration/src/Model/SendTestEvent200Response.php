...
/**
 * SendTestEvent200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SendTestEvent200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_test_event_200_response';
    ...
    */
     ...
     * Sets data
     *
     * @param string|null $data Indicates if the test event succeeded or failed.
     *
     * @return $this
     */
