...
/**
 * UpdateApplication400Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateApplication400Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'update_application_400_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\Administration\Model\UpdateApplication400ResponseError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\Administration\Model\UpdateApplication400ResponseError
     */
    public function getError(): \JackWH\NylasV3\Administration\Model\UpdateApplication400ResponseError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\Administration\Model\UpdateApplication400ResponseError $error error
     *
     * @return $this
     */
    public function setError(\JackWH\NylasV3\Administration\Model\UpdateApplication400ResponseError $error): static
    {
        if (is_null($error)) {
