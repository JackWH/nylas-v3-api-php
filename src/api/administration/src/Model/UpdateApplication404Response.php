...
/**
 * UpdateApplication404Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateApplication404Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'update_application_404_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\Administration\Model\UpdateApplication404ResponseError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\Administration\Model\UpdateApplication404ResponseError
     */
    public function getError(): \JackWH\NylasV3\Administration\Model\UpdateApplication404ResponseError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\Administration\Model\UpdateApplication404ResponseError $error error
     *
     * @return $this
     */
    public function setError(\JackWH\NylasV3\Administration\Model\UpdateApplication404ResponseError $error): static
    {
        if (is_null($error)) {
