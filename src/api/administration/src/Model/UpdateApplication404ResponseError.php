<?php
/**
 * UpdateApplication404ResponseError
 *
 * PHP version 8.1
 *
...
/**
 * UpdateApplication404ResponseError Class Doc Comment
 *
 ...
 */
class UpdateApplication404ResponseError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'update_application_404_response_error';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('message', $data ?? [], 'Resource not found');
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of error
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string|null $message Informative error message
     *
     * @return $this
     */
     ...
     * @return object|null
     */
    public function getProviderError(): ?object
    {
     ...
     * Sets provider_error
     *
     * @param object|null $provider_error (OPTIONAL) informative error message from provider's side
     *
     * @return $this
     */
    public function setProviderError(?object $provider_error): static
    {
