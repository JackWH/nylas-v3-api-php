<?php
/**
 * UpdateConnectorByProviderRequest
 *
 * PHP version 8.1
 *
...
/**
 * UpdateConnectorByProviderRequest Class Doc Comment
 *
 * @package  JackWH\NylasV3\Administration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateConnectorByProviderRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'update_connector_by_provider_request';
    ...
    */
     ...
     * Sets settings
     *
     * @param object|null $settings Oauth provider credentials and settings
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param string[]|null $scope Oauth \"scope\" parameter
     *
     * @return $this
     */
