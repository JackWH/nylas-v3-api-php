...
/**
 * YahooSettings Class Doc Comment
 *
 ...
 */
class YahooSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Yahoo_settings';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string $client_id The Yahoo app's client ID.
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret The Yahoo app's client secret.
     *
     * @return $this
     */
