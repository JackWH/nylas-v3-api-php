 ...
 */
class Zoom implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Zoom';
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The provider type. For Zoom providers, set to `zoom`.
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \JackWH\NylasV3\Administration\Model\ZoomSettings|null
     */
    public function getSettings(): ?\JackWH\NylasV3\Administration\Model\ZoomSettings
    {
     ...
     * Sets settings
     *
     * @param \JackWH\NylasV3\Administration\Model\ZoomSettings|null $settings settings
     *
     * @return $this
     */
    public function setSettings(?\JackWH\NylasV3\Administration\Model\ZoomSettings $settings): static
    {
        if (is_null($settings)) {
