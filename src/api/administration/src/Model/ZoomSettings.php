 ...
 */
class ZoomSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Zoom_settings';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string $client_id The Zoom app's client ID.
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret The Zoom app's client secret.
     *
     * @return $this
     */
