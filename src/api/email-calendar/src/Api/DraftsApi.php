...
class DraftsApi
{
    ...
    /**
     * Operation deleteDraftsId
     *
     * Delete a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteDraftsId'] to see the possible values for this operation
     *
     ...
     */
    public function deleteDraftsId(
        string $grant_id,
        string $draft_id,
        string $contentType = self::contentTypes['deleteDraftsId'][0]
    ): \JackWH\NylasV3\EmailCalendar\Model\DeleteCalendarsId200Response {
        list($response) = $this->deleteDraftsIdWithHttpInfo($grant_id, $draft_id, $contentType);

        return $response;
    }

    /**
     * Operation deleteDraftsIdWithHttpInfo
     *
     * Delete a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     */
    public function deleteDraftsIdWithHttpInfo(
        string $grant_id,
        string $draft_id,
        string $contentType = self::contentTypes['deleteDraftsId'][0]
    ): array {
        $request = $this->deleteDraftsIdRequest($grant_id, $draft_id, $contentType);
     ...
     */
    public function deleteDraftsIdAsync(
        string $grant_id,
        string $draft_id,
        string $contentType = self::contentTypes['deleteDraftsId'][0]
    ): PromiseInterface {
        return $this->deleteDraftsIdAsyncWithHttpInfo($grant_id, $draft_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteDraftsIdAsyncWithHttpInfo
     *
     * Delete a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function deleteDraftsIdAsyncWithHttpInfo(
        $grant_id,
        $draft_id,
        string $contentType = self::contentTypes['deleteDraftsId'][0]
    ): PromiseInterface {
    ...
    /**
     * Create request for operation 'deleteDraftsId'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteDraftsId'] to see the possible values for this operation
     ...
     */
    public function deleteDraftsIdRequest(
        $grant_id,
        $draft_id,
        string $contentType = self::contentTypes['deleteDraftsId'][0]
    ): Request {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling deleteDraftsId'
            );
        }
        ...
        if ($draft_id === null || (is_array($draft_id) && count($draft_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $draft_id when calling deleteDraftsId'
            );
        }


        $resourcePath = '/v3/grants/{grant_id}/drafts/{draft_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDraftId'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1
     */
    public function getDraftId(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        string $contentType = self::contentTypes['getDraftId'][0]
    ): \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response {
        list($response) = $this->getDraftIdWithHttpInfo($grant_id, $draft_id, $select, $contentType);

        return $response;
    }

    /**
     * Operation getDraftIdWithHttpInfo
     *
     * Return a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDraftIdWithHttpInfo(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        string $contentType = self::contentTypes['getDraftId'][0]
    ): array {
        $request = $this->getDraftIdRequest($grant_id, $draft_id, $select, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 400:
            ...
            $returnType = '\JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response';
            if (in_array($returnType, ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getDraftIdAsync(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        string $contentType = self::contentTypes['getDraftId'][0]
    ): PromiseInterface {
        return $this->getDraftIdAsyncWithHttpInfo($grant_id, $draft_id, $select, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDraftIdAsyncWithHttpInfo
     *
     * Return a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function getDraftIdAsyncWithHttpInfo(
        $grant_id,
        $draft_id,
        $select = null,
        string $contentType = self::contentTypes['getDraftId'][0]
    ...
    /**
     * Create request for operation 'getDraftId'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string|null $select Specify fields that you want Nylas to return, as a comma-separated list (for example, &#x60;select&#x3D;id,updated_at&#x60;). This allows you to receive only the portion of object data that you&#39;re interested in. You can use &#x60;select&#x60; to optimize response size and reduce latency by limiting queries to only the information that you need. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDraftIdRequest(
        $grant_id,
        $draft_id,
        $select = null,
        string $contentType = self::contentTypes['getDraftId'][0]
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling getDraftId'
            );
        }
        ...
        if ($draft_id === null || (is_array($draft_id) && count($draft_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $draft_id when calling getDraftId'
            );
        }
     ...
     * @param  string|null $any_email Return email messages that have been sent or received from this comma-separated list of email addresses (for example, &#x60;mail1@example.com,mail2@example.com&#x60;). You can specify a maximum of 25 email addresses. (optional)
     ...
     * @param  string|null $bcc Return items containing messages that were BCC&#39;d to this email address, likely sent from the parent account. (Most SMTP gateways remove BCC information, so this appears only if the user sent the email message, or received it because they were on the BCC list.) (optional)
     ...
     * @param  bool|null $has_attachment Return items with attachments. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDrafts'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\GetDrafts200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1
     */
    public function getDrafts(
        ...
        string $contentType = self::contentTypes['getDrafts'][0]
    ): \JackWH\NylasV3\EmailCalendar\Model\GetDrafts200Response {
        list($response) = $this->getDraftsWithHttpInfo($grant_id, $limit, $page_token, $select, $subject, $any_email, $to, $cc, $bcc, $starred, $thread_id, $has_attachment, $contentType);
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\GetDrafts200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDraftsWithHttpInfo(
        ...
        $request = $this->getDraftsRequest($grant_id, $limit, $page_token, $select, $subject, $any_email, $to, $cc, $bcc, $starred, $thread_id, $has_attachment, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\JackWH\NylasV3\EmailCalendar\Model\GetDrafts200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\JackWH\NylasV3\EmailCalendar\Model\GetDrafts200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\JackWH\NylasV3\EmailCalendar\Model\GetDrafts200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 400:
            ...
            $returnType = '\JackWH\NylasV3\EmailCalendar\Model\GetDrafts200Response';
            if (in_array($returnType, ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getDraftsAsync(
        ...
        return $this->getDraftsAsyncWithHttpInfo($grant_id, $limit, $page_token, $select, $subject, $any_email, $to, $cc, $bcc, $starred, $thread_id, $has_attachment, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function getDraftsRequest(
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling getDrafts'
            );
        }

        if ($limit !== null && $limit > 200) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling DraftsApi.getDrafts, must be smaller than or equal to 200.');
        }
        ...
        $resourcePath = '/v3/grants/{grant_id}/drafts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\Drafts1|null $drafts1 drafts1 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postDraft'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1
     */
    public function postDraft(
        string $grant_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\Drafts1 $drafts1 = null,
        string $contentType = self::contentTypes['postDraft'][0]
    ): \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response {
        list($response) = $this->postDraftWithHttpInfo($grant_id, $drafts1, $contentType);
     ...
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\Drafts1|null $drafts1 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postDraft'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1, HTTP status code, HTTP response headers (array of strings)
     */
    public function postDraftWithHttpInfo(
        string $grant_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\Drafts1 $drafts1 = null,
        string $contentType = self::contentTypes['postDraft'][0]
    ): array {
        $request = $this->postDraftRequest($grant_id, $drafts1, $contentType);
     ...
     * @return PromiseInterface
     */
    public function postDraftAsync(
        string $grant_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\Drafts1 $drafts1 = null,
        string $contentType = self::contentTypes['postDraft'][0]
    ): PromiseInterface {
        return $this->postDraftAsyncWithHttpInfo($grant_id, $drafts1, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postDraftAsyncWithHttpInfo
     *
     * Create a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function postDraftAsyncWithHttpInfo(
        $grant_id,
        $drafts1 = null,
        string $contentType = self::contentTypes['postDraft'][0]
    ): PromiseInterface {
    ...
    /**
     * Create request for operation 'postDraft'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\Drafts1|null $drafts1 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postDraft'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postDraftRequest(
        $grant_id,
        $drafts1 = null,
        string $contentType = self::contentTypes['postDraft'][0]
    ): Request {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling postDraft'
            );
        }
        ...
        if (isset($drafts1)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($drafts1));
            } else {
                $httpBody = $drafts1;
            }
     ...
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string|null $select Specify fields that you want Nylas to return, as a comma-separated list (for example, &#x60;select&#x3D;id,updated_at&#x60;). This allows you to receive only the portion of object data that you&#39;re interested in. You can use &#x60;select&#x60; to optimize response size and reduce latency by limiting queries to only the information that you need. (optional)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\Drafts2|null $drafts2 drafts2 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putDraftsId'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1
     */
    public function putDraftsId(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        ?\JackWH\NylasV3\EmailCalendar\Model\Drafts2 $drafts2 = null,
        string $contentType = self::contentTypes['putDraftsId'][0]
    ): \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response {
        list($response) = $this->putDraftsIdWithHttpInfo($grant_id, $draft_id, $select, $drafts2, $contentType);

        return $response;
    }

    /**
     * Operation putDraftsIdWithHttpInfo
     *
     * Update a draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string|null $select Specify fields that you want Nylas to return, as a comma-separated list (for example, &#x60;select&#x3D;id,updated_at&#x60;). This allows you to receive only the portion of object data that you&#39;re interested in. You can use &#x60;select&#x60; to optimize response size and reduce latency by limiting queries to only the information that you need. (optional)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\Drafts2|null $drafts2 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putDraftsId'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1, HTTP status code, HTTP response headers (array of strings)
     */
    public function putDraftsIdWithHttpInfo(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        ?\JackWH\NylasV3\EmailCalendar\Model\Drafts2 $drafts2 = null,
        ...
        $request = $this->putDraftsIdRequest($grant_id, $draft_id, $select, $drafts2, $contentType);
     ...
     * @return PromiseInterface
     */
    public function putDraftsIdAsync(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        ?\JackWH\NylasV3\EmailCalendar\Model\Drafts2 $drafts2 = null,
        ...
        return $this->putDraftsIdAsyncWithHttpInfo($grant_id, $draft_id, $select, $drafts2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putDraftsIdAsyncWithHttpInfo
     *
     * Update a draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function putDraftsIdAsyncWithHttpInfo(
        $grant_id,
        $draft_id,
        $select = null,
        $drafts2 = null,
    ...
    /**
     * Create request for operation 'putDraftsId'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string|null $select Specify fields that you want Nylas to return, as a comma-separated list (for example, &#x60;select&#x3D;id,updated_at&#x60;). This allows you to receive only the portion of object data that you&#39;re interested in. You can use &#x60;select&#x60; to optimize response size and reduce latency by limiting queries to only the information that you need. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putDraftsIdRequest(
        $grant_id,
        $draft_id,
        $select = null,
        $drafts2 = null,
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling putDraftsId'
            );
        }
        ...
        if ($draft_id === null || (is_array($draft_id) && count($draft_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $draft_id when calling putDraftsId'
            );
        }
        ...
        if (isset($drafts2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($drafts2));
            } else {
                $httpBody = $drafts2;
            }
        } elseif (count($formParams) > 0) {
     ...
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string|null $select Specify fields that you want Nylas to return, as a comma-separated list (for example, &#x60;select&#x3D;id,updated_at&#x60;). This allows you to receive only the portion of object data that you&#39;re interested in. You can use &#x60;select&#x60; to optimize response size and reduce latency by limiting queries to only the information that you need. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendDraftId'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error
     */
    public function sendDraftId(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        string $contentType = self::contentTypes['sendDraftId'][0]
    ): \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response {
        list($response) = $this->sendDraftIdWithHttpInfo($grant_id, $draft_id, $select, $contentType);

        return $response;
    }

    /**
     * Operation sendDraftIdWithHttpInfo
     *
     * Send a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\PostDraft200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendDraftIdWithHttpInfo(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        string $contentType = self::contentTypes['sendDraftId'][0]
    ): array {
        $request = $this->sendDraftIdRequest($grant_id, $draft_id, $select, $contentType);
     ...
     * @return PromiseInterface
     */
    public function sendDraftIdAsync(
        string $grant_id,
        string $draft_id,
        ?string $select = null,
        string $contentType = self::contentTypes['sendDraftId'][0]
    ): PromiseInterface {
        return $this->sendDraftIdAsyncWithHttpInfo($grant_id, $draft_id, $select, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sendDraftIdAsyncWithHttpInfo
     *
     * Send a Draft
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function sendDraftIdAsyncWithHttpInfo(
        $grant_id,
        $draft_id,
        $select = null,
        string $contentType = self::contentTypes['sendDraftId'][0]
    ...
    /**
     * Create request for operation 'sendDraftId'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  string $draft_id ID of the draft to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  string|null $select Specify fields that you want Nylas to return, as a comma-separated list (for example, &#x60;select&#x3D;id,updated_at&#x60;). This allows you to receive only the portion of object data that you&#39;re interested in. You can use &#x60;select&#x60; to optimize response size and reduce latency by limiting queries to only the information that you need. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendDraftIdRequest(
        $grant_id,
        $draft_id,
        $select = null,
        string $contentType = self::contentTypes['sendDraftId'][0]
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling sendDraftId'
            );
        }
        ...
        if ($draft_id === null || (is_array($draft_id) && count($draft_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $draft_id when calling sendDraftId'
            );
        }
