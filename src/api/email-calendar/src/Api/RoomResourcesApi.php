...
/**
 * RoomResourcesApi Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RoomResourcesApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listRoomResources'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\ListRoomResources200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1
     */
    public function listRoomResources(
        string $grant_id,
        ?int $limit = 50,
        ?string $page_token = null,
        string $contentType = self::contentTypes['listRoomResources'][0]
    ): \JackWH\NylasV3\EmailCalendar\Model\ListRoomResources200Response
    {
        list($response) = $this->listRoomResourcesWithHttpInfo($grant_id, $limit, $page_token, $contentType);
        return $response;
    }

    /**
     * Operation listRoomResourcesWithHttpInfo
     *
     * Return all room resources
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\ListRoomResources200Response|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error1|\JackWH\NylasV3\EmailCalendar\Model\Error1, HTTP status code, HTTP response headers (array of strings)
     */
    public function listRoomResourcesWithHttpInfo(
        string $grant_id,
        ?int $limit = 50,
        ?string $page_token = null,
        string $contentType = self::contentTypes['listRoomResources'][0]
    ...
    {
        $request = $this->listRoomResourcesRequest($grant_id, $limit, $page_token, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\JackWH\NylasV3\EmailCalendar\Model\ListRoomResources200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\JackWH\NylasV3\EmailCalendar\Model\ListRoomResources200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\JackWH\NylasV3\EmailCalendar\Model\ListRoomResources200Response', []),
            ...
            $returnType = '\JackWH\NylasV3\EmailCalendar\Model\ListRoomResources200Response';
    ...
    /**
     * Operation listRoomResourcesAsync
     *
     * Return all room resources
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     */
    public function listRoomResourcesAsync(
        string $grant_id,
        ?int $limit = 50,
        ?string $page_token = null,
        string $contentType = self::contentTypes['listRoomResources'][0]
    ...
    {
        return $this->listRoomResourcesAsyncWithHttpInfo($grant_id, $limit, $page_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listRoomResourcesAsyncWithHttpInfo
     *
     * Return all room resources
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function listRoomResourcesAsyncWithHttpInfo(
        $grant_id,
        $limit = 50,
        $page_token = null,
        string $contentType = self::contentTypes['listRoomResources'][0]
    ...
    /**
     * Create request for operation 'listRoomResources'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  int|null $limit The maximum number of objects to return. See [pagination](/docs/api/v3/ecc/#overview--pagination) for more information. (optional, default to 50)
     * @param  string|null $page_token An identifier that specifies which page of data to return. You can get this value from the &#x60;next_cursor&#x60; response field. See [Pagination](/docs/api/v3/ecc/#overview--pagination) for more information. (optional)
     ...
     */
    public function listRoomResourcesRequest(
        $grant_id,
        $limit = 50,
        $page_token = null,
        string $contentType = self::contentTypes['listRoomResources'][0]
    ): Request
    {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling listRoomResources'
            );
        }

        if ($limit !== null && $limit > 200) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling RoomResourcesApi.listRoomResources, must be smaller than or equal to 200.');
        }
        


        $resourcePath = '/v3/grants/{grant_id}/resources';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
