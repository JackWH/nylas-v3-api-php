...
/**
 * SmartComposeApi Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SmartComposeApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation postSmartCompose
     *
     * Compose a message
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\SmartCompose|null $smart_compose smart_compose (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postSmartCompose'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\PostSmartCompose200Response|\JackWH\NylasV3\EmailCalendar\Model\Error3|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error4|\JackWH\NylasV3\EmailCalendar\Model\Error3
     */
    public function postSmartCompose(
        string $grant_id,
    ...
    /**
     * Operation postSmartComposeWithHttpInfo
     *
     * Compose a message
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\SmartCompose|null $smart_compose (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postSmartCompose'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\PostSmartCompose200Response|\JackWH\NylasV3\EmailCalendar\Model\Error3|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error4|\JackWH\NylasV3\EmailCalendar\Model\Error3, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSmartComposeWithHttpInfo(
        string $grant_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\SmartCompose $smart_compose = null,
        string $contentType = self::contentTypes['postSmartCompose'][0]
    ): array {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\JackWH\NylasV3\EmailCalendar\Model\PostSmartCompose200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        if ('\JackWH\NylasV3\EmailCalendar\Model\PostSmartCompose200Response' !== 'string') {
                            try {
                ...
                case 422:
                    if (in_array('\JackWH\NylasV3\EmailCalendar\Model\Error4', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\JackWH\NylasV3\EmailCalendar\Model\Error4' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch ($e->getCode()) {
                ...
                case 422:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\JackWH\NylasV3\EmailCalendar\Model\Error4',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
    ...
    /**
     * Operation postSmartComposeAsync
     *
     * Compose a message
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     */
    public function postSmartComposeAsync(
        string $grant_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\SmartCompose $smart_compose = null,
        string $contentType = self::contentTypes['postSmartCompose'][0]
    ): PromiseInterface {
    ...
    /**
     * Operation postSmartComposeAsyncWithHttpInfo
     *
     * Compose a message
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function postSmartComposeAsyncWithHttpInfo(
        $grant_id,
        $smart_compose = null,
        string $contentType = self::contentTypes['postSmartCompose'][0]
    ): PromiseInterface {
    ...
    /**
     * Create request for operation 'postSmartCompose'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\SmartCompose|null $smart_compose (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postSmartCompose'] to see the possible values for this operation
     ...
     */
    public function postSmartComposeRequest(
        $grant_id,
        $smart_compose = null,
        string $contentType = self::contentTypes['postSmartCompose'][0]
    ): Request {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling postSmartCompose'
            );
        }
        ...
        // for model (json/xml)
        if (isset($smart_compose)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($smart_compose));
            } else {
                $httpBody = $smart_compose;
            }
    ...
    /**
     * Operation postSmartComposeReply
     *
     * Compose a reply
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @param  \JackWH\NylasV3\EmailCalendar\Model\SmartCompose|null $smart_compose smart_compose (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postSmartComposeReply'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \JackWH\NylasV3\EmailCalendar\Model\PostSmartCompose200Response|\JackWH\NylasV3\EmailCalendar\Model\Error3|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error4|\JackWH\NylasV3\EmailCalendar\Model\Error3
     */
    public function postSmartComposeReply(
        string $grant_id,
        string $message_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\SmartCompose $smart_compose = null,
    ...
    /**
     * Operation postSmartComposeReplyWithHttpInfo
     *
     * Compose a reply
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return array of \JackWH\NylasV3\EmailCalendar\Model\PostSmartCompose200Response|\JackWH\NylasV3\EmailCalendar\Model\Error3|\JackWH\NylasV3\EmailCalendar\Model\Error|\JackWH\NylasV3\EmailCalendar\Model\Error4|\JackWH\NylasV3\EmailCalendar\Model\Error3, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSmartComposeReplyWithHttpInfo(
        string $grant_id,
        string $message_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\SmartCompose $smart_compose = null,
        string $contentType = self::contentTypes['postSmartComposeReply'][0]
    ...
    /**
     * Operation postSmartComposeReplyAsync
     *
     * Compose a reply
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function postSmartComposeReplyAsync(
        string $grant_id,
        string $message_id,
        ?\JackWH\NylasV3\EmailCalendar\Model\SmartCompose $smart_compose = null,
        string $contentType = self::contentTypes['postSmartComposeReply'][0]
    ...
    /**
     * Operation postSmartComposeReplyAsyncWithHttpInfo
     *
     * Compose a reply
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function postSmartComposeReplyAsyncWithHttpInfo(
        $grant_id,
        $message_id,
        $smart_compose = null,
        string $contentType = self::contentTypes['postSmartComposeReply'][0]
    ...
    /**
     * Create request for operation 'postSmartComposeReply'
     *
     * @param  string $grant_id ID of the grant to access. Use &#x60;/me/&#x60; to refer to the grant associated with an access token. (required)
     * @param  string $message_id ID of the email message to access. Nylas recommends you URL-encode this field, or you might receive a [&#x60;404&#x60; error](/docs/api/errors/400-response/) if the ID contains special characters (for example, &#x60;#&#x60;). (required)
     * @param  \JackWH\NylasV3\EmailCalendar\Model\SmartCompose|null $smart_compose (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSmartComposeReplyRequest(
        $grant_id,
        $message_id,
        $smart_compose = null,
        string $contentType = self::contentTypes['postSmartComposeReply'][0]
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling postSmartComposeReply'
            );
        }
        ...
        if ($message_id === null || (is_array($message_id) && count($message_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $message_id when calling postSmartComposeReply'
            );
        }
