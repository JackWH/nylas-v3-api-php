...
class V3GrantsGrantIdDraftsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createADraft'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return object|object|object
     */
    public function createADraft(
        string $grant_id,
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
        string $contentType = self::contentTypes['createADraft'][0]
    ): object
    {
        list($response) = $this->createADraftWithHttpInfo($grant_id, $content_type, $accept, $body, $contentType);
        return $response;
    }

    /**
     * Operation createADraftWithHttpInfo
     *
     * Create a Draft
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     */
    public function createADraftWithHttpInfo(
        string $grant_id,
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
    ...
    {
        $request = $this->createADraftRequest($grant_id, $content_type, $accept, $body, $contentType);
     ...
     */
    public function createADraftAsync(
        string $grant_id,
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
    ...
    {
        return $this->createADraftAsyncWithHttpInfo($grant_id, $content_type, $accept, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createADraftAsyncWithHttpInfo
     *
     * Create a Draft
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function createADraftAsyncWithHttpInfo(
        $grant_id,
        $content_type = null,
        $accept = null,
        $body = null,
    ...
    /**
     * Create request for operation 'createADraft'
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     * @param  string|null $content_type (optional)
     * @param  string|null $accept (optional)
     ...
     */
    public function createADraftRequest(
        $grant_id,
        $content_type = null,
        $accept = null,
        $body = null,
    ...
    ): Request
    {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling createADraft'
            );
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['returnAllDrafts'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return object|object|object
     */
    public function returnAllDrafts(
        string $grant_id,
        ?string $accept = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['returnAllDrafts'][0]
    ): object
    {
        list($response) = $this->returnAllDraftsWithHttpInfo($grant_id, $accept, $limit, $contentType);
        return $response;
    }

    /**
     * Operation returnAllDraftsWithHttpInfo
     *
     * Return all Drafts
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return array of object|object|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnAllDraftsWithHttpInfo(
        string $grant_id,
        ?string $accept = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['returnAllDrafts'][0]
    ...
    {
        $request = $this->returnAllDraftsRequest($grant_id, $accept, $limit, $contentType);
    ...
    /**
     * Operation returnAllDraftsAsync
     *
     * Return all Drafts
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function returnAllDraftsAsync(
        string $grant_id,
        ?string $accept = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['returnAllDrafts'][0]
    ...
    {
        return $this->returnAllDraftsAsyncWithHttpInfo($grant_id, $accept, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation returnAllDraftsAsyncWithHttpInfo
     *
     * Return all Drafts
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function returnAllDraftsAsyncWithHttpInfo(
        $grant_id,
        $accept = null,
        $limit = null,
        string $contentType = self::contentTypes['returnAllDrafts'][0]
    ...
    /**
     * Create request for operation 'returnAllDrafts'
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     * @param  string|null $accept (optional)
     * @param  int|null $limit The number of objects to return. This field defaults to 50. The maximum allowed value for this field is 200.  See [pagination](#section/Pagination) for more information. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function returnAllDraftsRequest(
        $grant_id,
        $accept = null,
        $limit = null,
        string $contentType = self::contentTypes['returnAllDrafts'][0]
    ): Request
    {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling returnAllDrafts'
            );
        }
