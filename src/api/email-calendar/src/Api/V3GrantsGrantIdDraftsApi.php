...
/**
 * V3GrantsGrantIdDraftsApi Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class V3GrantsGrantIdDraftsApi
{
    /**
     * @var ClientInterface
     */
    ...
    public const contentTypes = [
        'v3GrantsGrantIdDraftsGet' => [
            'application/json',
        ],
        'v3GrantsGrantIdDraftsPost' => [
            'application/json',
        ],
    ];
    ...
    /**
     * Operation v3GrantsGrantIdDraftsGet
     *
     * Return all Drafts
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v3GrantsGrantIdDraftsGet'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return object|object|object
     */
    public function v3GrantsGrantIdDraftsGet(
        string $grant_id,
        ?string $accept = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['v3GrantsGrantIdDraftsGet'][0]
    ): object
    {
        list($response) = $this->v3GrantsGrantIdDraftsGetWithHttpInfo($grant_id, $accept, $limit, $contentType);
        return $response;
    }

    /**
     * Operation v3GrantsGrantIdDraftsGetWithHttpInfo
     *
     * Return all Drafts
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     */
    public function v3GrantsGrantIdDraftsGetWithHttpInfo(
        string $grant_id,
        ?string $accept = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['v3GrantsGrantIdDraftsGet'][0]
    ...
    {
        $request = $this->v3GrantsGrantIdDraftsGetRequest($grant_id, $accept, $limit, $contentType);
    ...
    /**
     * Operation v3GrantsGrantIdDraftsGetAsync
     *
     * Return all Drafts
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     */
    public function v3GrantsGrantIdDraftsGetAsync(
        string $grant_id,
        ?string $accept = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['v3GrantsGrantIdDraftsGet'][0]
    ...
    {
        return $this->v3GrantsGrantIdDraftsGetAsyncWithHttpInfo($grant_id, $accept, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v3GrantsGrantIdDraftsGetAsyncWithHttpInfo
     *
     * Return all Drafts
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function v3GrantsGrantIdDraftsGetAsyncWithHttpInfo(
        $grant_id,
        $accept = null,
        $limit = null,
        string $contentType = self::contentTypes['v3GrantsGrantIdDraftsGet'][0]
    ...
    /**
     * Create request for operation 'v3GrantsGrantIdDraftsGet'
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     * @param  string|null $accept (optional)
     * @param  int|null $limit The number of objects to return. This field defaults to 50. The maximum allowed value for this field is 200.  See [pagination](#section/Pagination) for more information. (optional)
     ...
     */
    public function v3GrantsGrantIdDraftsGetRequest(
        $grant_id,
        $accept = null,
        $limit = null,
        string $contentType = self::contentTypes['v3GrantsGrantIdDraftsGet'][0]
    ): Request
    {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling v3GrantsGrantIdDraftsGet'
            );
        }
    ...
    /**
     * Operation v3GrantsGrantIdDraftsPost
     *
     * Create a Draft
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v3GrantsGrantIdDraftsPost'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return object|object|object
     */
    public function v3GrantsGrantIdDraftsPost(
        string $grant_id,
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
        string $contentType = self::contentTypes['v3GrantsGrantIdDraftsPost'][0]
    ): object
    {
        list($response) = $this->v3GrantsGrantIdDraftsPostWithHttpInfo($grant_id, $content_type, $accept, $body, $contentType);
        return $response;
    }

    /**
     * Operation v3GrantsGrantIdDraftsPostWithHttpInfo
     *
     * Create a Draft
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return array of object|object|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function v3GrantsGrantIdDraftsPostWithHttpInfo(
        string $grant_id,
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
    ...
    {
        $request = $this->v3GrantsGrantIdDraftsPostRequest($grant_id, $content_type, $accept, $body, $contentType);
    ...
    /**
     * Operation v3GrantsGrantIdDraftsPostAsync
     *
     * Create a Draft
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function v3GrantsGrantIdDraftsPostAsync(
        string $grant_id,
        ?string $content_type = null,
        ?string $accept = null,
        ?array $body = null,
    ...
    {
        return $this->v3GrantsGrantIdDraftsPostAsyncWithHttpInfo($grant_id, $content_type, $accept, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v3GrantsGrantIdDraftsPostAsyncWithHttpInfo
     *
     * Create a Draft
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     ...
     * @return PromiseInterface
     */
    public function v3GrantsGrantIdDraftsPostAsyncWithHttpInfo(
        $grant_id,
        $content_type = null,
        $accept = null,
        $body = null,
    ...
    /**
     * Create request for operation 'v3GrantsGrantIdDraftsPost'
     *
     * @param  string $grant_id (Required) ID of the Grant to act upon. Use \&quot;me\&quot; to refer to the Grant associated with an access token. (required)
     * @param  string|null $content_type (optional)
     * @param  string|null $accept (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v3GrantsGrantIdDraftsPostRequest(
        $grant_id,
        $content_type = null,
        $accept = null,
        $body = null,
    ...
    ): Request
    {
        ...
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $grant_id when calling v3GrantsGrantIdDraftsPost'
            );
        }
