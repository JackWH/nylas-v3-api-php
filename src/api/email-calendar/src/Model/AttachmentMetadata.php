...
class AttachmentMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'attachment_metadata';
    ...
    */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling AttachmentMetadata., must be bigger than or equal to 1.');
        }
    ...
    public function setContentType(?string $content_type): static
    {
        ...
        if ((mb_strlen($content_type) < 1)) {
            throw new InvalidArgumentException('invalid length for $content_type when calling AttachmentMetadata., must be bigger than or equal to 1.');
        }
    ...
    public function setFilename(?string $filename): static
    {
        ...
        if ((mb_strlen($filename) < 1)) {
            throw new InvalidArgumentException('invalid length for $filename when calling AttachmentMetadata., must be bigger than or equal to 1.');
        }
