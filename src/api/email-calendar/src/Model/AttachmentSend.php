 ...
 */
class AttachmentSend implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'attachment_send';
    ...
    */
    ...
    public function setContentType(?string $content_type): static
    {
        ...
        if ((mb_strlen($content_type) < 1)) {
            throw new InvalidArgumentException('invalid length for $content_type when calling AttachmentSend., must be bigger than or equal to 1.');
        }
    ...
    public function setFilename(?string $filename): static
    {
        ...
        if ((mb_strlen($filename) < 1)) {
            throw new InvalidArgumentException('invalid length for $filename when calling AttachmentSend., must be bigger than or equal to 1.');
        }
