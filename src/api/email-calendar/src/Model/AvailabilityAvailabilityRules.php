 ...
 */
class AvailabilityAvailabilityRules implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'availability_availability_rules';
    ...
    public const AVAILABILITY_METHOD_COLLECTIVE = 'collective';
    public const AVAILABILITY_METHOD_MAX_FAIRNESS = 'max-fairness';
    public const AVAILABILITY_METHOD_MAX_AVAILABILITY = 'max-availability';
     ...
     * @return string[]
     */
    public function getAvailabilityMethodAllowableValues()
    {
        return [
            self::AVAILABILITY_METHOD_COLLECTIVE,
            self::AVAILABILITY_METHOD_MAX_FAIRNESS,
            self::AVAILABILITY_METHOD_MAX_AVAILABILITY,
        ];
    }
    ...
    {
        $this->setIfExists('availability_method', $data ?? [], 'max-availability');
        $this->setIfExists('buffer', $data ?? [], null);
        $this->setIfExists('default_open_hours', $data ?? [], null);
        $this->setIfExists('round_robin_group_id', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getAvailabilityMethod(): ?string
    {
        return $this->container['availability_method'];
    }

    /**
     * Sets availability_method
     *
     * @param string|null $availability_method availability_method
     *
     * @return $this
     */
    public function setAvailabilityMethod(?string $availability_method): static
    {
        if (is_null($availability_method)) {
        ...
        $this->container['availability_method'] = $availability_method;
     ...
     * Gets buffer
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Buffer|null
     */
    public function getBuffer(): ?\JackWH\NylasV3\EmailCalendar\Model\Buffer
    {
     ...
     * Sets buffer
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Buffer|null $buffer buffer
     *
     * @return $this
     */
    public function setBuffer(?\JackWH\NylasV3\EmailCalendar\Model\Buffer $buffer): static
    {
        if (is_null($buffer)) {
    ...
    /**
     * Gets default_open_hours
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\OpenHours[]|null
     */
    public function getDefaultOpenHours(): ?array
    {
        return $this->container['default_open_hours'];
    }

    /**
     * Sets default_open_hours
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\OpenHours[]|null $default_open_hours A default set of open hours to apply to all participants. You can overwrite these open hours for individual participants by specifying `open_hours` on the Participant object.
     *
     * @return $this
     */
    public function setDefaultOpenHours(?array $default_open_hours): static
    {
        if (is_null($default_open_hours)) {
            throw new InvalidArgumentException('non-nullable default_open_hours cannot be null');
        }
        $this->container['default_open_hours'] = $default_open_hours;

        return $this;
    }

    /**
     * Gets round_robin_group_id
     *
     * @return string|null
     */
    public function getRoundRobinGroupId(): ?string
    {
        return $this->container['round_robin_group_id'];
    }

    /**
     * Sets round_robin_group_id
     *
     * @param string|null $round_robin_group_id The ID on events that Nylas considers when calculating the order of round-robin participants. This is used for both max-fairness and max-availability calculations.  To calculate participant order correctly, set the metadata key `key5` to the same value on any events you want to consider for the current set of round-robin participants. You can set this key to any value that helps you identify events used to calculate availability in this group (for example, `new_subscriber_onboarding`).
     *
     * @return $this
     */
    public function setRoundRobinGroupId(?string $round_robin_group_id): static
    {
        if (is_null($round_robin_group_id)) {
            throw new InvalidArgumentException('non-nullable round_robin_group_id cannot be null');
        }
        $this->container['round_robin_group_id'] = $round_robin_group_id;
