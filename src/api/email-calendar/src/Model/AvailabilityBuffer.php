 ...
 */
class AvailabilityBuffer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'availability_buffer';
    ...
    */
    ...
    public function setBefore(?int $before): static
    {
        ...
        if (($before > 120)) {
            throw new InvalidArgumentException('invalid value for $before when calling AvailabilityBuffer., must be smaller than or equal to 120.');
        }
        if (($before < 0)) {
            throw new InvalidArgumentException('invalid value for $before when calling AvailabilityBuffer., must be bigger than or equal to 0.');
        }
    ...
    public function setAfter(?int $after): static
    {
        ...
        if (($after > 120)) {
            throw new InvalidArgumentException('invalid value for $after when calling AvailabilityBuffer., must be smaller than or equal to 120.');
        }
        if (($after < 0)) {
            throw new InvalidArgumentException('invalid value for $after when calling AvailabilityBuffer., must be bigger than or equal to 0.');
        }
