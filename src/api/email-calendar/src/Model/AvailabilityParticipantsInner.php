 ...
 */
class AvailabilityParticipantsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'availability_participants_inner';
    ...
    */
     ...
     * Sets calendar_ids
     *
     * @param string[]|null $calendar_ids A list of calendar IDs associated with each participant's email address. If empty, Nylas uses the participant's primary calendar ID.
     *
     * @return $this
     */
    public function setCalendarIds(?array $calendar_ids): static
    {
     ...
     * Sets open_hours
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\OpenHours[]|null $open_hours An array of the participant's open hours. Nylas searches for free time slots within these open hours.
     *
     * @return $this
     */
