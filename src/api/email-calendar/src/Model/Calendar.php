...
class Calendar implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Calendar';
    ...
    */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling Calendar., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool|null $is_owned_by_user If `true`, indicates that the end user owns the calendar. This field _cannot_ be modified once set.
     *
     * @return $this
     */
     ...
     * Sets is_primary
     *
     * @param bool|null $is_primary If `true`, indicates that the calendar is the primary for the grant.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the calendar.
     *
     * @return $this
     */
     ...
     * Sets read_only
     *
     * @param bool|null $read_only Set by the provider. If `true`, indicates that the calendar is read-only.  If the calendar is read-only, all of its events have `read_only` set to `true`. This field _cannot_ be modified.
     *
     * @return $this
     */
