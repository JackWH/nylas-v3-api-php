...
/**
 * CalendarMetadata Class Doc Comment
 *
 * @description The metadata associated with the object. For more information, see [metadata](/docs/api/v3/ecc/#overview--metadata).
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class CalendarMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Calendar_metadata';
    ...
    {
        $this->setIfExists('your_key', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (! is_null($this->container['your_key']) && (mb_strlen($this->container['your_key']) > 550)) {
            $invalidProperties[] = "invalid value for 'your_key', the character length must be smaller than or equal to 550.";
        }
     ...
     * @return string|null
     */
    public function getYourKey(): ?string
    {
        return $this->container['your_key'];
    }

    /**
     * Sets your_key
     *
     * @param string|null $your_key A key-value pair.
     *
     * @return $this
     */
    public function setYourKey(?string $your_key): static
    {
        if (is_null($your_key)) {
            throw new InvalidArgumentException('non-nullable your_key cannot be null');
        }
        if ((mb_strlen($your_key) > 550)) {
            throw new InvalidArgumentException('invalid length for $your_key when calling CalendarMetadata., must be smaller than or equal to 550.');
        }

        $this->container['your_key'] = $your_key;
