 ...
 */
class CleanMessagesRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'clean_messages_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ignore_links', $data ?? [], true);
        $this->setIfExists('ignore_images', $data ?? [], true);
        $this->setIfExists('images_as_markdown', $data ?? [], true);
        $this->setIfExists('ignore_tables', $data ?? [], true);
        $this->setIfExists('remove_conclusion_phrases', $data ?? [], true);
    }
    ...
    */
     ...
     * Sets message_id
     *
     * @param string[]|null $message_id IDs of the email messages to clean.
     *
     * @return $this
     */
    public function setMessageId(?array $message_id): static
    {
        ...
        if ((count($message_id) > 20)) {
            throw new InvalidArgumentException('invalid value for $message_id when calling CleanMessagesRequest., number of items must be less than or equal to 20.');
        }
     ...
     * @return bool|null
     */
    public function getIgnoreLinks(): ?bool
    {
     ...
     * Sets ignore_links
     *
     * @param bool|null $ignore_links If `true`, removes link-related tags (`<a>`) from the email message while keeping the text.
     *
     * @return $this
     */
    public function setIgnoreLinks(?bool $ignore_links): static
    {
        if (is_null($ignore_links)) {
            throw new InvalidArgumentException('non-nullable ignore_links cannot be null');
        }
     ...
     * @return bool|null
     */
    public function getIgnoreImages(): ?bool
    {
        return $this->container['ignore_images'];
    }

    /**
     * Sets ignore_images
     *
     * @param bool|null $ignore_images If `true`, removes images from the email message.
     *
     * @return $this
     */
    public function setIgnoreImages(?bool $ignore_images): static
    {
        if (is_null($ignore_images)) {
            throw new InvalidArgumentException('non-nullable ignore_images cannot be null');
        }
        $this->container['ignore_images'] = $ignore_images;

        return $this;
    }

    /**
     * Gets images_as_markdown
     *
     * @return bool|null
     */
    public function getImagesAsMarkdown(): ?bool
    {
        return $this->container['images_as_markdown'];
    }

    /**
     * Sets images_as_markdown
     *
     * @param bool|null $images_as_markdown If `true`, converts images in the email message to Markdown.
     *
     * @return $this
     */
    public function setImagesAsMarkdown(?bool $images_as_markdown): static
    {
        if (is_null($images_as_markdown)) {
            throw new InvalidArgumentException('non-nullable images_as_markdown cannot be null');
        }
        $this->container['images_as_markdown'] = $images_as_markdown;
     ...
     * @return bool|null
     */
    public function getIgnoreTables(): ?bool
    {
     ...
     * Sets ignore_tables
     *
     * @param bool|null $ignore_tables If `true`, removes table-related tags (`<table>`, `<th>`, `<td>`, `<tr>`) from the email message while keeping rows.
     *
     * @return $this
     */
    public function setIgnoreTables(?bool $ignore_tables): static
    {
        if (is_null($ignore_tables)) {
            throw new InvalidArgumentException('non-nullable ignore_tables cannot be null');
        }
    ...
    /**
     * Gets remove_conclusion_phrases
     *
     * @return bool|null
     */
    public function getRemoveConclusionPhrases(): ?bool
    {
        return $this->container['remove_conclusion_phrases'];
    }

    /**
     * Sets remove_conclusion_phrases
     *
     * @param bool|null $remove_conclusion_phrases If `true`, removes phrases such as \"Best\" and \"Regards\" in the email message signature.
     *
     * @return $this
     */
    public function setRemoveConclusionPhrases(?bool $remove_conclusion_phrases): static
    {
        if (is_null($remove_conclusion_phrases)) {
            throw new InvalidArgumentException('non-nullable remove_conclusion_phrases cannot be null');
        }
        $this->container['remove_conclusion_phrases'] = $remove_conclusion_phrases;
