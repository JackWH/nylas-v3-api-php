...
/**
 * CommonResponseWithCursor Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CommonResponseWithCursor implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'common_response_with_cursor';
    ...
    */
     ...
     * Sets data
     *
     * @param string|null $data The response object.
     *
     * @return $this
     */
