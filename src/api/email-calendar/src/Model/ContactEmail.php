...
/**
 * ContactEmail Class Doc Comment
 *
 * @description An array of the contact&#39;s email addresses. EWS supports up to three email addresses.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ContactEmail implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contact_Email';
    ...
    */
    ...
    public function setEmail(string $email): static
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new InvalidArgumentException('invalid length for $email when calling ContactEmail., must be smaller than or equal to 255.');
        }
     ...
     * Sets type
     *
     * @param string|null $type (Google only) The email address type.
     *
     * @return $this
     */
