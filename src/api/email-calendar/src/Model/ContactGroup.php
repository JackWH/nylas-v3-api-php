...
class ContactGroup implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contact_Group';
    ...
    public const GROUP_TYPE_USER = 'user';
    public const GROUP_TYPE_OTHER = 'other';
    ...
    public function getGroupTypeAllowableValues()
    {
        return [
            ...
            self::GROUP_TYPE_USER,
            self::GROUP_TYPE_OTHER,
        ];
    }
    ...
    */
     ...
     * Sets group_type
     *
     * @param string|null $group_type The Contact Group type.
     *
     * @return $this
     */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling ContactGroup., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string|null $name The Contact Group display name.
     *
     * @return $this
     */
     ...
     * Sets path
     *
     * @param string|null $path The Contact Group's path.
     *
     * @return $this
     */
