 ...
 *
 * @description An array of the contact&#39;s instant messaging (IM) addresses.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ContactImAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contact_im_address';
    ...
    {
        $this->setIfExists('im_address', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['im_address'] === null) {
            $invalidProperties[] = "'im_address' can't be null";
        }
        if ((mb_strlen($this->container['im_address']) > 255)) {
            $invalidProperties[] = "invalid value for 'im_address', the character length must be smaller than or equal to 255.";
        }
    ...
    {
        return $this->container['im_address'];
    }

    /**
     * Sets im_address
     *
     * @param string $im_address The contact's IM address.
     *
     * @return $this
     */
    public function setImAddress(string $im_address): static
    {
        if (is_null($im_address)) {
            throw new InvalidArgumentException('non-nullable im_address cannot be null');
        }
        if ((mb_strlen($im_address) > 255)) {
            throw new InvalidArgumentException('invalid length for $im_address when calling ContactImAddress., must be smaller than or equal to 255.');
        }

        $this->container['im_address'] = $im_address;
     ...
     * Sets type
     *
     * @param string|null $type The protocol for the IM address.
     *
     * @return $this
     */
