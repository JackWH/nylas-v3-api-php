 ...
 */
class ContactPhoneNumber implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contact_Phone_Number';
    ...
    */
     ...
     * Sets number
     *
     * @param string $number The contact's phone number, including its [country code](https://www.itu.int/oth/T0202.aspx?parent=T0202).
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type The phone number type.
     *
     * @return $this
     */
