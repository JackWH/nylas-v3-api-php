 ...
 *
 * @description An array of physical addresses associated with the contact.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ContactPhysicalAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contact_Physical_Address';
    ...
    */
     ...
     * Sets street_address
     *
     * @param string|null $street_address The street address of a location associated with the contact (for example, their work).
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code of a location associated with the contact.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string|null $state The state or province in which the contact is located.
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string|null $country The country in which the contact is located.
     *
     * @return $this
     */
     ...
     * Sets city
     *
     * @param string|null $city The town or city in which the contact is located.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type The physical address type.
     *
     * @return $this
     */
