 ...
 *
 * @description An array of the contact&#39;s websites. EWS supports only one &#x60;work&#x60; website per contact.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ContactWebPage implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contact_Web_Page';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url A URL that links to the contact's website.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type The website type.
     *
     * @return $this
     */
