 ...
 */
class ContactWithPicture implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contact_With_Picture';
    ...
    */
     ...
     * Sets given_name
     *
     * @param string|null $given_name The contact's given name.
     *
     * @return $this
     */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling ContactWithPicture., must be bigger than or equal to 1.');
        }
     ...
     * Sets object
     *
     * @param string|null $object The response object type.
     *
     * @return $this
     */
     ...
     * Sets picture_url
     *
     * @param string|null $picture_url A URL that links to the contact's picture.
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string|null $source The source of the contact. For example, `address_book`, `domain`, or `inbox`.
     *
     * @return $this
     */
     ...
     * Sets picture
     *
     * @param string|null $picture The contact's picture, represented as a Base64-encoded string.
     *
     * @return $this
     */
