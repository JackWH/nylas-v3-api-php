 ...
 */
class CreateEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_event';
    ...
    */
    ...
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 8192)) {
            throw new InvalidArgumentException('invalid length for $description when calling CreateEvent., must be smaller than or equal to 8192.');
        }
    ...
    public function setLocation(?string $location): static
    {
        ...
        if ((mb_strlen($location) > 255)) {
            throw new InvalidArgumentException('invalid length for $location when calling CreateEvent., must be smaller than or equal to 255.');
        }
    ...
    public function setTitle(?string $title): static
    {
        ...
        if ((mb_strlen($title) > 1024)) {
            throw new InvalidArgumentException('invalid length for $title when calling CreateEvent., must be smaller than or equal to 1024.');
        }
