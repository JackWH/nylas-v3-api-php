...
/**
 * CreateEventParticipantsInner Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateEventParticipantsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_event_participants_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The participant's full name.
     *
     * @return $this
     */
