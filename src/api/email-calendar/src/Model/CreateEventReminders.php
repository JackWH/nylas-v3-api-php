...
/**
 * CreateEventReminders Class Doc Comment
 *
 ...
 */
class CreateEventReminders implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_event_reminders';
