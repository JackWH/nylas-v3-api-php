<?php
/**
 * CreateEventRemindersOverridesInner
 *
 * PHP version 8.1
 *
...
/**
 * CreateEventRemindersOverridesInner Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateEventRemindersOverridesInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_event_reminders_overrides_inner';
    ...
    public const REMINDER_METHOD_POPUP = 'popup';
    public const REMINDER_METHOD_EMAIL = 'email';
    public const REMINDER_METHOD_DISPLAY = 'display';
    public const REMINDER_METHOD_SOUND = 'sound';
     ...
     * @return string[]
     */
    public function getReminderMethodAllowableValues()
    {
        return [
            self::REMINDER_METHOD_POPUP,
            self::REMINDER_METHOD_EMAIL,
            self::REMINDER_METHOD_DISPLAY,
            self::REMINDER_METHOD_SOUND,
        ];
    }
    ...
    {
        $this->setIfExists('reminder_minutes', $data ?? [], null);
        $this->setIfExists('reminder_method', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['reminder_minutes'];
    }

    /**
     * Sets reminder_minutes
     *
     * @param int|null $reminder_minutes The number of minutes before the event start time when a user wants to receive a reminder for this event.
     *
     * @return $this
     */
    public function setReminderMinutes(?int $reminder_minutes): static
    {
        if (is_null($reminder_minutes)) {
            throw new InvalidArgumentException('non-nullable reminder_minutes cannot be null');
        }
        $this->container['reminder_minutes'] = $reminder_minutes;

        return $this;
    }

    /**
     * Gets reminder_method
     *
     * @return string|null
     */
    public function getReminderMethod(): ?string
    {
        return $this->container['reminder_method'];
    }

    /**
     * Sets reminder_method
     *
     * @param string|null $reminder_method (Google and iCloud only) The method used to notify the end user about the event, with separate options and default settings for each provider.  - **Google**:   - Default: `popup`   - Options: `popup`, `email` - **iCloud**:   - Default: `display`   - Options: `display`, `sound` - **EWS**:   - Default: `display`   - Options: `display`, `email`
     *
     * @return $this
     */
    public function setReminderMethod(?string $reminder_method): static
    {
        if (is_null($reminder_method)) {
        ...
        $this->container['reminder_method'] = $reminder_method;
