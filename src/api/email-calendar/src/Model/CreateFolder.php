 ...
 */
class CreateFolder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_folder';
    ...
    */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 1024)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateFolder., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateFolder., must be bigger than or equal to 1.');
        }
