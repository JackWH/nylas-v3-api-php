...
/**
 * CreateFolder1 Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateFolder1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_folder_1';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Creates a folder with the specified display name.
     *
     * @return $this
     */
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 1024)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateFolder1., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateFolder1., must be bigger than or equal to 1.');
        }
