<?php
/**
 * DeleteAScheduledMessage202Response
 *
 * PHP version 8.1
 *
 ...
 */
class DeleteAScheduledMessage202Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'delete_a_scheduled_message_202_response';
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\DeleteAScheduledMessage202ResponseData
     */
    public function getData(): \JackWH\NylasV3\EmailCalendar\Model\DeleteAScheduledMessage202ResponseData
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\DeleteAScheduledMessage202ResponseData $data data
     *
     * @return $this
     */
    public function setData(\JackWH\NylasV3\EmailCalendar\Model\DeleteAScheduledMessage202ResponseData $data): static
    {
        if (is_null($data)) {
