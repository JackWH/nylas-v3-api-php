 ...
 */
class Drafts implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Drafts';
    ...
    */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling Drafts., must be bigger than or equal to 1.');
        }
    ...
    public function setSnippet(?string $snippet): static
    {
        ...
        if ((mb_strlen($snippet) < 1)) {
            throw new InvalidArgumentException('invalid length for $snippet when calling Drafts., must be bigger than or equal to 1.');
        }
    ...
    public function setTo(?array $to): static
    {
        ...
        if ((count($to) < 1)) {
            throw new InvalidArgumentException('invalid length for $to when calling Drafts., number of items must be greater than or equal to 1.');
        }
