...
/**
 * Drafts2AttachmentsInner Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class Drafts2AttachmentsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Drafts_2_attachments_inner';
    ...
    */
     ...
     * Sets content
     *
     * @param string|null $content Must be Base64-encoded if using the `application/json` schema. Use binary format if using `multipart/form-data`.
     *
     * @return $this
     */
