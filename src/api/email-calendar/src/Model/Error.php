...
class Error implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\EmailCalendar\Model\ErrorError',
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\ErrorError|null
     */
    public function getError(): ?\JackWH\NylasV3\EmailCalendar\Model\ErrorError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\ErrorError|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\EmailCalendar\Model\ErrorError $error): static
    {
        if (is_null($error)) {
