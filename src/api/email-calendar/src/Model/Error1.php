 ...
 */
class Error1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'error_1';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\EmailCalendar\Model\Error1Error'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Error1Error|null
     */
    public function getError(): ?\JackWH\NylasV3\EmailCalendar\Model\Error1Error
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Error1Error|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\EmailCalendar\Model\Error1Error $error): static
    {
        if (is_null($error)) {
