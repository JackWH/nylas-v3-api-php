 ...
 */
class Error2Error implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'error_2_error';
    ...
    */
     ...
     * Sets provider_error
     *
     * @param string|null $provider_error Provider Error
     *
     * @return $this
     */
    public function setProviderError(?string $provider_error): static
    {
