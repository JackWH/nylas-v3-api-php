 ...
 */
class Error3 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'error_3';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\EmailCalendar\Model\Error3Error'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Error3Error|null
     */
    public function getError(): ?\JackWH\NylasV3\EmailCalendar\Model\Error3Error
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Error3Error|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\EmailCalendar\Model\Error3Error $error): static
    {
        if (is_null($error)) {
