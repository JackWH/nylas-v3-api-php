 ...
 */
class Error4 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'error_4';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'error' => '\JackWH\NylasV3\EmailCalendar\Model\Error4Error'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Error4Error|null
     */
    public function getError(): ?\JackWH\NylasV3\EmailCalendar\Model\Error4Error
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Error4Error|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\EmailCalendar\Model\Error4Error $error): static
    {
        if (is_null($error)) {
