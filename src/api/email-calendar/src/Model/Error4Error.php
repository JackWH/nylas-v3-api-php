 ...
 */
class Error4Error implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'error_4_error';
    ...
    */
     ...
     * Gets details
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Error4ErrorDetailsInner[]|null
     */
     ...
     * Sets details
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Error4ErrorDetailsInner[]|null $details details
     *
     * @return $this
     */
