 ...
 */
class Error4ErrorDetailsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'error_4_error_details_inner';
    ...
    */
     ...
     * Gets loc
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Error4ErrorDetailsInnerLocInner[]|null
     */
     ...
     * Sets loc
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Error4ErrorDetailsInnerLocInner[]|null $loc loc
     *
     * @return $this
     */
