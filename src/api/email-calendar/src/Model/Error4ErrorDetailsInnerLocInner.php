<?php
/**
 * Error4ErrorDetailsInnerLocInner
 *
 * PHP version 8.1
 *
 ...
 */
class Error4ErrorDetailsInnerLocInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'error_4_error_details_inner_loc_inner';
