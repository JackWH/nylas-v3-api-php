...
/**
 * EventConferencing Class Doc Comment
 *
 ...
 */
class EventConferencing implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Event_conferencing';
    ...
    */
    ...
    public function setProvider(?string $provider): static
    {
        ...
        if ((mb_strlen($provider) < 1)) {
            throw new InvalidArgumentException('invalid length for $provider when calling EventConferencing., must be bigger than or equal to 1.');
        }
