...
/**
 * EventConferencingRequest Class Doc Comment
 *
 * @description An object that allows you to automatically create a conference or enter conferencing details manually.  You _cannot_ use &#x60;autocreate&#x60; and &#x60;details&#x60; in the same request.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class EventConferencingRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_conferencing_request';
    ...
    public const PROVIDER_GOOGLE_MEET = 'Google Meet';
    public const PROVIDER_ZOOM_MEETING = 'Zoom Meeting';
    public const PROVIDER_MICROSOFT_TEAMS = 'Microsoft Teams';
    ...
    public function getProviderAllowableValues()
    {
        return [
            ...
            self::PROVIDER_ZOOM_MEETING,
            self::PROVIDER_MICROSOFT_TEAMS,
        ];
    }
    ...
    */
    ...
    public function setProvider(?string $provider): static
    {
        ...
        if ((mb_strlen($provider) < 1)) {
            throw new InvalidArgumentException('invalid length for $provider when calling EventConferencingRequest., must be bigger than or equal to 1.');
        }
