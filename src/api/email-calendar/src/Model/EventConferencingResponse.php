...
/**
 * EventConferencingResponse Class Doc Comment
 *
 * @description An object that contains event conferencing details. Nylas also appends the conference details to the Event description.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class EventConferencingResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_conferencing_response';
    ...
    */
    ...
    public function setProvider(?string $provider): static
    {
        ...
        if ((mb_strlen($provider) < 1)) {
            throw new InvalidArgumentException('invalid length for $provider when calling EventConferencingResponse., must be bigger than or equal to 1.');
        }
