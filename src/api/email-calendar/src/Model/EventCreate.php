 ...
 */
class EventCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_create';
    ...
    */
     ...
     * Sets capacity
     *
     * @param int|null $capacity (Not supported for EWS events) The maximum number of participants that may attend the event.
     *
     * @return $this
     */
    ...
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 8192)) {
            throw new InvalidArgumentException('invalid length for $description when calling EventCreate., must be smaller than or equal to 8192.');
        }
     ...
     *
     * @param bool|null $hide_participants (Not supported for EWS events) When `true`, hides the event's list of participants.
     *
     * @return $this
     */
    ...
    public function setLocation(?string $location): static
    {
        ...
        if ((mb_strlen($location) > 255)) {
            throw new InvalidArgumentException('invalid length for $location when calling EventCreate., must be smaller than or equal to 255.');
        }
     ...
     * Gets reminders
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\CreateEventReminders|null
     */
    public function getReminders(): ?\JackWH\NylasV3\EmailCalendar\Model\CreateEventReminders
    {
     ...
     * Sets reminders
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\CreateEventReminders|null $reminders reminders
     *
     * @return $this
     */
    public function setReminders(?\JackWH\NylasV3\EmailCalendar\Model\CreateEventReminders $reminders): static
    {
    ...
    public function setTitle(?string $title): static
    {
        ...
        if ((mb_strlen($title) > 1024)) {
            throw new InvalidArgumentException('invalid length for $title when calling EventCreate., must be smaller than or equal to 1024.');
        }
     ...
     * Gets when
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\When1
     */
     ...
     * Sets when
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\When1 $when when
     *
     * @return $this
     */
