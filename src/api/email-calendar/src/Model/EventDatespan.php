...
/**
 * EventDatespan Class Doc Comment
 *
 * @description (Not supported for iCloud events) A span of days, without specific clock-based start and end times (for example, a business quarter or semester).
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class EventDatespan implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_datespan';
    ...
    */
    ...
    public function setStartDate(?string $start_date): static
    {
        ...
        if ((mb_strlen($start_date) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_date when calling EventDatespan., must be bigger than or equal to 1.');
        }
