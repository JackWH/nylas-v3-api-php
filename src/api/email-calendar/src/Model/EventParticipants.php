...
/**
 * EventParticipants Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EventParticipants implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_participants';
    ...
    public const STATUS_NOREPLY = 'noreply';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('status', $data ?? [], 'noreply');
    }
    ...
    */
     ...
     * Sets comment
     *
     * @param string|null $comment A comment about the participant (for example, their nickname).
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The participant's full name. Not all providers store participant names, so this field may be null, or an empty string.
     *
     * @return $this
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The participant's phone number.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The participant's attendance status.
     *
     * @return $this
     */
