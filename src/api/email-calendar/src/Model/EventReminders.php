 ...
 *
 * @description A list of reminders to generate for the event. If not defined, Nylas uses the provider&#39;s default settings.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class EventReminders implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Event_reminders';
    ...
    */
     ...
     * Gets overrides
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\EventRemindersOverridesInner[]|null
     */
