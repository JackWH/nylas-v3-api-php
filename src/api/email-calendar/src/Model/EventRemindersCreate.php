...
/**
 * EventRemindersCreate Class Doc Comment
 *
 ...
 */
class EventRemindersCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_reminders_create';
    ...
    protected static array $openAPITypes = [
        'use_default' => 'bool',
        'overrides' => '\JackWH\NylasV3\EmailCalendar\Model\CreateEventRemindersOverridesInner[]',
    ];
    ...
    */
     ...
     * Sets use_default
     *
     * @param bool|null $use_default When `true`, the event uses the calendar's default reminder settings.  - **Google**: Generates a `popup`-style reminder 10 minutes before the event begins. - **Microsoft**: Generates a reminder 15 minutes before the event begins. - **iCloud**: Does not generate a reminder. - **EWS**: Generates a `display`-style reminder 15 minutes before the event begins.
     *
     * @return $this
     */
    public function setUseDefault(?bool $use_default): static
    {
     ...
     * Gets overrides
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\CreateEventRemindersOverridesInner[]|null
     */
