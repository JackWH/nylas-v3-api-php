 ...
 */
class EventRemindersOverridesInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Event_reminders_overrides_inner';
    ...
    */
     ...
     *
     * @param int|null $reminder_minutes The number of minutes before the event to display a reminder.
     *
     * @return $this
     */
