...
/**
 * EventResourcesInner Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EventResourcesInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Event_resources_inner';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email The resource's email address.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The resource's full name.
     *
     * @return $this
     */
