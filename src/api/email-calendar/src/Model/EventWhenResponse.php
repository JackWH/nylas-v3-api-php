 ...
 *
 * @description An object that represents the time and duration of an event. Nylas might format &#x60;when&#x60; as one of three sub-objects: &#x60;timespan&#x60;, &#x60;date&#x60;, or &#x60;datespan&#x60;. These sub-objects allow Nylas to capture and represent specific points in time.  &#x60;timespan&#x60; objects include optional timezone support.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class EventWhenResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_when_response';
    ...
    */
    ...
    public function setStartTimezone(?string $start_timezone): static
    {
        ...
        if ((mb_strlen($start_timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_timezone when calling EventWhenResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setEndTimezone(?string $end_timezone): static
    {
        ...
        if ((mb_strlen($end_timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $end_timezone when calling EventWhenResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setStartDate(?string $start_date): static
    {
        ...
        if ((mb_strlen($start_date) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_date when calling EventWhenResponse., must be bigger than or equal to 1.');
        }
