...
/**
 * FreebusyRequest Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FreebusyRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'freebusy_request';
    ...
    */
     ...
     * Sets start_time
     *
     * @param int $start_time The start of a time block, in Unix epoch format. Nylas uses `start_time` and `end_time` to assess the specified account's free/busy schedule.
     *
     * @return $this
     */
     ...
     * Sets end_time
     *
     * @param int $end_time The end of a time block, in Unix epoch format. Nylas uses `start_time` and `end_time` to assess the specified account's free/busy schedule.  Nylas can query a timespan of up to 30 days from the `start_time`.
     *
     * @return $this
     */
     ...
     * Sets emails
     *
     * @param string[] $emails A list of email addresses to check the free/busy schedules for.
     *
     * @return $this
     */
