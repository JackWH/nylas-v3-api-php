 ...
 */
class GetAttachmentsId200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_attachments_id_200_response';
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\GetAttachmentsId200ResponseAllOfData|null
     */
    public function getData(): ?\JackWH\NylasV3\EmailCalendar\Model\GetAttachmentsId200ResponseAllOfData
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\GetAttachmentsId200ResponseAllOfData|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\EmailCalendar\Model\GetAttachmentsId200ResponseAllOfData $data): static
    {
        if (is_null($data)) {
