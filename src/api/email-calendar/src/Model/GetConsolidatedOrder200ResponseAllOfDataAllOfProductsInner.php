<?php
/**
 * GetConsolidatedOrder200ResponseAllOfDataAllOfProductsInner
 *
 * PHP version 8.1
 *
 ...
 */
class GetConsolidatedOrder200ResponseAllOfDataAllOfProductsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_consolidated_order_200_response_allOf_data_allOf_products_inner';
    ...
    */
     ...
     * Sets image_url
     *
     * @param string|null $image_url A URL that directs to an image of the product, or an image associated with the product.
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The quantity of the product that was ordered.
     *
     * @return $this
     */
     ...
     * Sets unit_price
     *
     * @param float|null $unit_price The unit price of the product.
     *
     * @return $this
     */
