<?php
/**
 * GetConsolidatedOrder400Response
 *
 * PHP version 8.1
 *
 ...
 */
class GetConsolidatedOrder400Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_consolidated_order_400_response';
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedOrder400ResponseError|null
     */
    public function getError(): ?\JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedOrder400ResponseError
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedOrder400ResponseError|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedOrder400ResponseError $error): static
    {
        if (is_null($error)) {
     ...
     * Sets request_id
     *
     * @param string|null $request_id The ID for each request.
     *
     * @return $this
     */
