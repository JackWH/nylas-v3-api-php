<?php
/**
 * GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentDeliveryStatus
 *
 * PHP version 8.1
 *
...
/**
 * GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentDeliveryStatus Class Doc Comment
 *
 * @description 
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 ...
 */
class GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentDeliveryStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_consolidated_shipment_200_response_allOf_data_allOf_carrier_enrichment_delivery_status';
    ...
    */
     ...
     * Sets description
     *
     * @param string $description A text description of the shipment status.
     *
     * @return $this
     */
     ...
     *
     * @param string $carrier_description A description of the status from the carrier.
     *
     * @return $this
     */
    public function setCarrierDescription(string $carrier_description): static
    {
