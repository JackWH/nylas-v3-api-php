<?php
/**
 * GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentPackageActivityInner
 *
 * PHP version 8.1
 *
 ...
 */
class GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentPackageActivityInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_consolidated_shipment_200_response_allOf_data_allOf_carrier_enrichment_package_activity_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('carrier_location', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['carrier_location'] === null) {
            $invalidProperties[] = "'carrier_location' can't be null";
        }
     ...
     */
    public function getStatus(): \JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentDeliveryStatus
    {
     ...
     * Sets status
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentDeliveryStatus $status status
     *
     * @return $this
     */
    public function setStatus(\JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentDeliveryStatus $status): static
    {
        if (is_null($status)) {
     ...
     * Gets location
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentSihpToAddress
     */
    public function getLocation(): \JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentSihpToAddress
    {
     ...
     * Sets location
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentSihpToAddress $location location
     *
     * @return $this
     */
    public function setLocation(\JackWH\NylasV3\EmailCalendar\Model\GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentSihpToAddress $location): static
    {
        if (is_null($location)) {
    ...
    /**
     * Gets carrier_location
     *
     * @return string
     */
    public function getCarrierLocation(): string
    {
        return $this->container['carrier_location'];
    }

    /**
     * Sets carrier_location
     *
     * @param string $carrier_location The location of the carrier.
     *
     * @return $this
     */
    public function setCarrierLocation(string $carrier_location): static
    {
        if (is_null($carrier_location)) {
            throw new InvalidArgumentException('non-nullable carrier_location cannot be null');
        }
        $this->container['carrier_location'] = $carrier_location;
     ...
     * Sets timestamp
     *
     * @param int $timestamp The time when the activity occurred, in Unix epoch format.
     *
     * @return $this
     */
