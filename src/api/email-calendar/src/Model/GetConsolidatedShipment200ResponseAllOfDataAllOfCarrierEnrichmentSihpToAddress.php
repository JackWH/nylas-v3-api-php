<?php
/**
 * GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentSihpToAddress
 *
 * PHP version 8.1
 *
...
/**
 * GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentSihpToAddress Class Doc Comment
 *
 * @description
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 ...
 */
class GetConsolidatedShipment200ResponseAllOfDataAllOfCarrierEnrichmentSihpToAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_consolidated_shipment_200_response_allOf_data_allOf_carrier_enrichment_sihp_to_address';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['state_province_code'] === null) {
            $invalidProperties[] = "'state_province_code' can't be null";
        }
     ...
     *
     * @param string $state_province_code The state or province code
     *
     * @return $this
     */
    public function setStateProvinceCode(string $state_province_code): static
    {
