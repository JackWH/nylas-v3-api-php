<?php
/**
 * GetConsolidatedShipment200ResponseAllOfDataAllOfOrder
 *
 * PHP version 8.1
 *
 ...
 */
class GetConsolidatedShipment200ResponseAllOfDataAllOfOrder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_consolidated_shipment_200_response_allOf_data_allOf_order';
