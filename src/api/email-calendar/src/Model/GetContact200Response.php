...
class GetContact200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_contact_200_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'data' => '\JackWH\NylasV3\EmailCalendar\Model\ContactWithPicture',
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\ContactWithPicture|null
     */
    public function getData(): ?\JackWH\NylasV3\EmailCalendar\Model\ContactWithPicture
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\ContactWithPicture|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\EmailCalendar\Model\ContactWithPicture $data): static
    {
        if (is_null($data)) {
