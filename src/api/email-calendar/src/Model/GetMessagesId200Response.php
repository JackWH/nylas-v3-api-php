...
/**
 * GetMessagesId200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetMessagesId200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_messages_id_200_response';
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Message|null
     */
    public function getData(): ?\JackWH\NylasV3\EmailCalendar\Model\Message
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Message|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\EmailCalendar\Model\Message $data): static
    {
        if (is_null($data)) {
