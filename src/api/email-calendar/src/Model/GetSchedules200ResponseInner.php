...
/**
 * GetSchedules200ResponseInner Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetSchedules200ResponseInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_schedules_200_response_inner';
    ...
    */
     ...
     * Sets schedule_id
     *
     * @param string $schedule_id The ID of the scheduled email message.
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\GetSchedules200ResponseInnerStatus
     */
    public function getStatus(): \JackWH\NylasV3\EmailCalendar\Model\GetSchedules200ResponseInnerStatus
    {
     ...
     * Sets status
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\GetSchedules200ResponseInnerStatus $status status
     *
     * @return $this
     */
    public function setStatus(\JackWH\NylasV3\EmailCalendar\Model\GetSchedules200ResponseInnerStatus $status): static
    {
        if (is_null($status)) {
     ...
     * Sets close_time
     *
     * @param int|null $close_time The time that your email message was sent, or failed to send, in Unix epoch format.
     *
     * @return $this
     */
    public function setCloseTime(?int $close_time): static
    {
