<?php
/**
 * GetSchedules200ResponseInnerStatus
 *
 * PHP version 8.1
 *
 ...
 *
 * @description The status of the specified scheduled email message.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class GetSchedules200ResponseInnerStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_schedules_200_response_inner_status';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code The status code which describes the state of the specified scheduled email message.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description A description of the status of the specified scheduled email message.
     *
     * @return $this
     */
