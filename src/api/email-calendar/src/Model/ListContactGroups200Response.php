 ...
 */
class ListContactGroups200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'list_contact_groups_200_response';
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\ContactGroup[]|null
     */
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\ContactGroup[]|null $data data
     *
     * @return $this
     */
