    ...
    */
    ...
    public function setSnippet(?string $snippet): static
    {
        ...
        if ((mb_strlen($snippet) < 1)) {
            throw new InvalidArgumentException('invalid length for $snippet when calling Message., must be bigger than or equal to 1.');
        }
    ...
    public function setThreadId(?string $thread_id): static
    {
        ...
        if ((mb_strlen($thread_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $thread_id when calling Message., must be bigger than or equal to 1.');
        }
