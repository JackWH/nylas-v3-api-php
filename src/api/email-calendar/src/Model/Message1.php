...
/**
 * Message1 Class Doc Comment
 *
 * @description The latest email message or draft in the thread.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class Message1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Message_1';
    ...
    */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling Message1., must be bigger than or equal to 1.');
        }
    ...
    public function setSnippet(?string $snippet): static
    {
        ...
        if ((mb_strlen($snippet) < 1)) {
            throw new InvalidArgumentException('invalid length for $snippet when calling Message1., must be bigger than or equal to 1.');
        }
    ...
    public function setThreadId(?string $thread_id): static
    {
        ...
        if ((mb_strlen($thread_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $thread_id when calling Message1., must be bigger than or equal to 1.');
        }
