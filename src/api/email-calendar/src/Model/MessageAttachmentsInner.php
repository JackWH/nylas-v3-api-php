...
/**
 * MessageAttachmentsInner Class Doc Comment
 *
 * @description 
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 ...
 */
class MessageAttachmentsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Message_attachments_inner';
    ...
    */
    ...
    public function setContentType(?string $content_type): static
    {
        ...
        if ((mb_strlen($content_type) < 1)) {
            throw new InvalidArgumentException('invalid length for $content_type when calling MessageAttachmentsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setFilename(?string $filename): static
    {
        ...
        if ((mb_strlen($filename) < 1)) {
            throw new InvalidArgumentException('invalid length for $filename when calling MessageAttachmentsInner., must be bigger than or equal to 1.');
        }
