...
/**
 * MessageUpdatePayload Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MessageUpdatePayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Message_Update_payload';
    ...
    */
     ...
     * Sets starred
     *
     * @param bool|null $starred Set to `true` to mark as starred; `false` to mark as not starred.
     *
     * @return $this
     */
     ...
     * Sets unread
     *
     * @param bool|null $unread Set to `true` to mark as unread; `false` to mark as read.
     *
     * @return $this
     */
     ...
     * Sets folders
     *
     * @param string[]|null $folders The ID(s) of the folder(s) to apply, overwriting all folders previously associated with the message. Microsoft messages can be in a single folder only. Google allows a single message to appear in multiple folders.
     *
     * @return $this
     */
