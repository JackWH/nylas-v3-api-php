 ...
 */
class OpenHours implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Open_Hours';
    ...
    */
    ...
    public function setTimezone(?string $timezone): static
    {
        ...
        if ((mb_strlen($timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $timezone when calling OpenHours., must be bigger than or equal to 1.');
        }
    ...
    public function setStart(?string $start): static
    {
        ...
        if ((mb_strlen($start) < 1)) {
            throw new InvalidArgumentException('invalid length for $start when calling OpenHours., must be bigger than or equal to 1.');
        }
    ...
    public function setEnd(?string $end): static
    {
        ...
        if ((mb_strlen($end) < 1)) {
            throw new InvalidArgumentException('invalid length for $end when calling OpenHours., must be bigger than or equal to 1.');
        }
