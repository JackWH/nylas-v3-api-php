 ...
 */
class Organizer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'organizer';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The organizer's full name.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string|null $email The organizer's email address.
     *
     * @return $this
     */
