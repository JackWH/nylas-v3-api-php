<?php
/**
 * PostAvailability200ResponseAllOfData
 *
 * PHP version 8.1
 *
...
/**
 * PostAvailability200ResponseAllOfData Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostAvailability200ResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_availability_200_response_allOf_data';
    ...
    */
     ...
     * Sets order
     *
     * @param string[]|null $order (Round-robin events only) The order of participants in line to attend the proposed meeting.
     *
     * @return $this
     */
     ...
     * Gets time_slots
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\TimeSlot[]|null
     */
     ...
     * Sets time_slots
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\TimeSlot[]|null $time_slots An array of the available time slots when you can create a meeting using the requested settings.
     *
     * @return $this
     */
