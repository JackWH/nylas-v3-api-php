<?php
/**
 * PostCalendarsFreeBusy200ResponseDataInner
 *
 * PHP version 8.1
 *
 ...
 */
class PostCalendarsFreeBusy200ResponseDataInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_calendars_free_busy_200_response_data_inner';
    ...
    public const OBJECT_FREE_BUSY = 'free_busy';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email The participant's email address.
     *
     * @return $this
     */
     ...
     * Gets time_slots
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\PostCalendarsFreeBusy200ResponseDataInnerTimeSlotsInner[]|null
     */
     ...
     * Sets time_slots
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\PostCalendarsFreeBusy200ResponseDataInnerTimeSlotsInner[]|null $time_slots An array of busy time slots.
     *
     * @return $this
     */
    public function setTimeSlots(?array $time_slots): static
    {
     ...
     * Sets error
     *
     * @param string|null $error If Nylas encounters an error fetching data for a participant, this field contains a description of the error.
     *
     * @return $this
     */
     ...
     * Sets object
     *
     * @param string|null $object The object type. If the request succeeds, the value is `free_busy`. If the request fails, the value is `error`.
     *
     * @return $this
     */
