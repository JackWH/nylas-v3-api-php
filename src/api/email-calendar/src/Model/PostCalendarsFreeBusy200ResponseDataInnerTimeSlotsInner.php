<?php
/**
 * PostCalendarsFreeBusy200ResponseDataInnerTimeSlotsInner
 *
 * PHP version 8.1
 *
 ...
 */
class PostCalendarsFreeBusy200ResponseDataInnerTimeSlotsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_calendars_free_busy_200_response_data_inner_time_slots_inner';
    ...
    */
     ...
     * Sets start_time
     *
     * @param int|null $start_time The beginning of a time slot, in Unix epoch format.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the time slot.
     *
     * @return $this
     */
     ...
     * Sets object
     *
     * @param string|null $object The object type (in this case, always `time_slot`).
     *
     * @return $this
     */
