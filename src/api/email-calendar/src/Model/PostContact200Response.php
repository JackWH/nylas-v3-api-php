...
/**
 * PostContact200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostContact200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_contact_200_response';
    ...
    */
     ...
     */
    public function getData(): ?\JackWH\NylasV3\EmailCalendar\Model\Contact
    {
     ...
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\EmailCalendar\Model\Contact $data): static
    {
        if (is_null($data)) {
