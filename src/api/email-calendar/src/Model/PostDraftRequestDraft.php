 ...
 */
class PostDraftRequestDraft implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_draft_request_draft';
    ...
    */
     ...
     * Sets thread_id
     *
     * @param string|null $thread_id A reference to the parent Thread object. If you're creating a new draft, leave this empty.
     *
     * @return $this
     */
