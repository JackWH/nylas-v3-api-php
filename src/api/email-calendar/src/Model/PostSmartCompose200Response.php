...
/**
 * PostSmartCompose200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostSmartCompose200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_smart_compose_200_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'data' => '\JackWH\NylasV3\EmailCalendar\Model\PromptSuggestion'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\PromptSuggestion|null
     */
    public function getData(): ?\JackWH\NylasV3\EmailCalendar\Model\PromptSuggestion
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\PromptSuggestion|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\EmailCalendar\Model\PromptSuggestion $data): static
    {
        if (is_null($data)) {
