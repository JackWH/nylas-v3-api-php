 ...
 */
class PostSmartCompose200Response1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_smart_compose_200_response_1';
