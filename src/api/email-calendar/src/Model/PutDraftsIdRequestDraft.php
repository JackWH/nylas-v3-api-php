 ...
 */
class PutDraftsIdRequestDraft implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'put_drafts_id_request_draft';
    ...
    */
     ...
     * Sets thread_id
     *
     * @param string|null $thread_id A reference to the parent Thread object.
     *
     * @return $this
     */
