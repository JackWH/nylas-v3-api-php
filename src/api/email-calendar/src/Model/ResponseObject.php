...
class ResponseObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'response_object';
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling ResponseObject., must be bigger than or equal to 1.');
        }
