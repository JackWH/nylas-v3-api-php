 ...
 */
class RoomResource implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Room_Resource';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('floor_name', $data ?? [], null);
        $this->setIfExists('floor_number', $data ?? [], null);
        $this->setIfExists('floor_section', $data ?? [], null);
    ...
    */
     ...
     * Sets building
     *
     * @param string|null $building The name of the building where the room is located.
     *
     * @return $this
     */
     ...
     * Sets capacity
     *
     * @param int|null $capacity The number of people the room can seat.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string|null $email The email address associated with the room resource.
     *
     * @return $this
     */
    ...
    {
        return $this->container['floor_name'];
    }

    /**
     * Sets floor_name
     *
     * @param string|null $floor_name The name of the floor where the room is located.
     *
     * @return $this
     */
    public function setFloorName(?string $floor_name): static
    {
        if (is_null($floor_name)) {
            throw new InvalidArgumentException('non-nullable floor_name cannot be null');
        }
        $this->container['floor_name'] = $floor_name;
     ...
     * Sets floor_number
     *
     * @param int|null $floor_number The floor number where the room is located.
     *
     * @return $this
     */
    public function setFloorNumber(?int $floor_number): static
    {
     ...
     * @return string|null
     */
    public function getFloorSection(): ?string
    {
        return $this->container['floor_section'];
    }

    /**
     * Sets floor_section
     *
     * @param string|null $floor_section The section of the floor where the room is located.
     *
     * @return $this
     */
    public function setFloorSection(?string $floor_section): static
    {
        if (is_null($floor_section)) {
            throw new InvalidArgumentException('non-nullable floor_section cannot be null');
        }
        $this->container['floor_section'] = $floor_section;
     ...
     * Sets object
     *
     * @param string|null $object The object type (in this case, `room_resource`).
     *
     * @return $this
     */
