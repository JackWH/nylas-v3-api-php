...
/**
 * SendMailNow202Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SendMailNow202Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_mail_now_202_response';
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\Message
     */
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\Message $data data
     *
     * @return $this
     */
