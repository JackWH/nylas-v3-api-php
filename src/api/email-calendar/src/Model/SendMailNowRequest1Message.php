 ...
 */
class SendMailNowRequest1Message implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_mail_now_request_1_message';
    ...
    */
     ...
     * Sets to
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\MessageParticipant[]|null $to to
     *
     * @return $this
     */
     ...
     * Sets send_at
     *
     * @param int|null $send_at The time when the email message will be sent, in Unix epoch format.
     *
     * @return $this
     */
