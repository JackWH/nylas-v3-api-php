<?php
/**
 * SendMailNowRequestAttachmentsInner
 *
 * PHP version 8.1
 *
...
/**
 * SendMailNowRequestAttachmentsInner Class Doc Comment
 *
 * @description
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 ...
 */
class SendMailNowRequestAttachmentsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_mail_now_request_attachments_inner';
    ...
    */
     ...
     * Sets content
     *
     * @param string|null $content Must be Base64-encoded if you're using the `application/json` schema. Use binary format if you're using `multipart/form-data`. For more information, see [Working with email attachments](/docs/v3/email/attachments/#attachment-schemas-and-size-limits).
     *
     * @return $this
     */
     ...
     * Sets content_type
     *
     * @param string|null $content_type The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types) of the attachment, used by the email client to determine how to display the attachment. If you don't provide a type, Nylas infers it from the file name.
     *
     * @return $this
     */
    public function setContentType(?string $content_type): static
    {
        ...
        if ((mb_strlen($content_type) < 1)) {
            throw new InvalidArgumentException('invalid length for $content_type when calling SendMailNowRequestAttachmentsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setFilename(?string $filename): static
    {
        ...
        if ((mb_strlen($filename) < 1)) {
            throw new InvalidArgumentException('invalid length for $filename when calling SendMailNowRequestAttachmentsInner., must be bigger than or equal to 1.');
        }
