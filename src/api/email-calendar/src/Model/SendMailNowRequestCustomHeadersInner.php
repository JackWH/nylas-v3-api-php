<?php
/**
 * SendMailNowRequestCustomHeadersInner
 *
 * PHP version 8.1
 *
 ...
 */
class SendMailNowRequestCustomHeadersInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_mail_now_request_custom_headers_inner';
