<?php
/**
 * SendMailNowRequestTrackingOptions
 *
 * PHP version 8.1
 *
 ...
 */
class SendMailNowRequestTrackingOptions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_mail_now_request_tracking_options';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('thread_replies', $data ?? [], null);
    ...
    */
     ...
     * @return $this
     */
    public function setOpens(?bool $opens): static
    {
        if (is_null($opens)) {
     ...
     * @return bool|null
     */
    public function getThreadReplies(): ?bool
    {
        return $this->container['thread_replies'];
    }

    /**
     * Sets thread_replies
     *
     * @param bool|null $thread_replies thread_replies
     *
     * @return $this
     */
    public function setThreadReplies(?bool $thread_replies): static
    {
        if (is_null($thread_replies)) {
            throw new InvalidArgumentException('non-nullable thread_replies cannot be null');
        }
        $this->container['thread_replies'] = $thread_replies;
     ...
     * @return $this
     */
    public function setLinks(?bool $links): static
    {
        if (is_null($links)) {
    ...
    public function setLabel(?string $label): static
    {
        ...
        if ((mb_strlen($label) > 2048)) {
            throw new InvalidArgumentException('invalid length for $label when calling SendMailNowRequestTrackingOptions., must be smaller than or equal to 2048.');
        }
