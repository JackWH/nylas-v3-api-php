...
/**
 * SendRsvp200Response Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SendRsvp200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_rsvp_200_response';
    ...
    protected static array $openAPITypes = [
        'request_id' => 'string',
        'data' => '\JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfData',
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfData|null
     */
    public function getData(): ?\JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfData
    {
     ...
     * Sets data
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfData|null $data data
     *
     * @return $this
     */
    public function setData(?\JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfData $data): static
    {
        if (is_null($data)) {
