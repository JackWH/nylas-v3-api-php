 ...
 */
class SendRsvp200ResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_rsvp_200_response_allOf_data';
    ...
    {
        $this->setIfExists('send_ics_error', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets send_ics_error
     *
     * @return \JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfDataSendIcsError|null
     */
    public function getSendIcsError(): ?\JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfDataSendIcsError
    {
        return $this->container['send_ics_error'];
    }

    /**
     * Sets send_ics_error
     *
     * @param \JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfDataSendIcsError|null $send_ics_error send_ics_error
     *
     * @return $this
     */
    public function setSendIcsError(?\JackWH\NylasV3\EmailCalendar\Model\SendRsvp200ResponseAllOfDataSendIcsError $send_ics_error): static
    {
        if (is_null($send_ics_error)) {
            throw new InvalidArgumentException('non-nullable send_ics_error cannot be null');
        }
        $this->container['send_ics_error'] = $send_ics_error;
