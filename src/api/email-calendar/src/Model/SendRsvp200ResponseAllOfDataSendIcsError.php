<?php
/**
 * SendRsvp200ResponseAllOfDataSendIcsError
 *
 * PHP version 8.1
 *
...
/**
 * SendRsvp200ResponseAllOfDataSendIcsError Class Doc Comment
 *
 * @description If an error occurs while sending an updated ICS file to the organizer of an event, Nylas returns an error message in this field. The event is still updated, but the ICS file is _not_ sent to the organizer.
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class SendRsvp200ResponseAllOfDataSendIcsError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_rsvp_200_response_allOf_data_send_ics_error';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of error that occurred.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string|null $message A human-readable message with details about the error.
     *
     * @return $this
     */
