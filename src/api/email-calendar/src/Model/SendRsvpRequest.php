...
/**
 * SendRsvpRequest Class Doc Comment
 *
 * @package  JackWH\NylasV3\EmailCalendar
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SendRsvpRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'send_rsvp_request';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status A participant's RSVP status for the event.
     *
     * @return $this
     */
