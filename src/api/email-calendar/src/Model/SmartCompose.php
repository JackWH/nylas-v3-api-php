 ...
 */
class SmartCompose implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Smart_Compose';
    ...
    */
     ...
     * Sets prompt
     *
     * @param string|null $prompt The prompt that Smart Compose uses to generate a message suggestion.
     *
     * @return $this
     */
    public function setPrompt(?string $prompt): static
    {
        ...
        if ((mb_strlen($prompt) > 1000)) {
            throw new InvalidArgumentException('invalid length for $prompt when calling SmartCompose., must be smaller than or equal to 1000.');
        }
