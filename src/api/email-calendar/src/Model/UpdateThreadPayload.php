 ...
 */
class UpdateThreadPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Update_thread_payload';
    ...
    */
     ...
     * Sets starred
     *
     * @param bool|null $starred When `true`, indicates that the thread is starred.
     *
     * @return $this
     */
     ...
     * Sets folders
     *
     * @param string[]|null $folders The IDs of the folders to apply to the thread. This overwrites all previously assigned folders for all email messages in the thread.
     *
     * @return $this
     */
