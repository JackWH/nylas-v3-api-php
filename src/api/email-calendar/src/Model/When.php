 ...
 */
class When implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'When';
    ...
    */
    ...
    public function setStartTimezone(?string $start_timezone): static
    {
        ...
        if ((mb_strlen($start_timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_timezone when calling When., must be bigger than or equal to 1.');
        }
    ...
    public function setEndTimezone(?string $end_timezone): static
    {
        ...
        if ((mb_strlen($end_timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $end_timezone when calling When., must be bigger than or equal to 1.');
        }
    ...
    public function setStartDate(?string $start_date): static
    {
        ...
        if ((mb_strlen($start_date) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_date when calling When., must be bigger than or equal to 1.');
        }
