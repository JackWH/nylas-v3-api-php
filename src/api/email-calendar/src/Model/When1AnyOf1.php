 ...
 */
class When1AnyOf1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'When_1_anyOf_1';
    ...
    */
    ...
    public function setStartTimezone(?string $start_timezone): static
    {
        if (is_null($start_timezone)) {
            array_push($this->openAPINullablesSetToNull, 'start_timezone');
        } else {
        ...
        if (! is_null($start_timezone) && (mb_strlen($start_timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_timezone when calling When1AnyOf1., must be bigger than or equal to 1.');
        }
    ...
    public function setEndTimezone(?string $end_timezone): static
    {
        if (is_null($end_timezone)) {
            array_push($this->openAPINullablesSetToNull, 'end_timezone');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
        ...
        if (! is_null($end_timezone) && (mb_strlen($end_timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $end_timezone when calling When1AnyOf1., must be bigger than or equal to 1.');
        }
