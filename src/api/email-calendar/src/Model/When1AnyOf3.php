 ...
 */
class When1AnyOf3 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'When_1_anyOf_3';
    ...
    */
    ...
    public function setStartDate(?string $start_date): static
    {
        ...
        if ((mb_strlen($start_date) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_date when calling When1AnyOf3., must be bigger than or equal to 1.');
        }
