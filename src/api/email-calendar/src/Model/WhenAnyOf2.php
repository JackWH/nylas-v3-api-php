 ...
 */
class WhenAnyOf2 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'When_anyOf_2';
    ...
    */
    ...
    public function setStartDate(?string $start_date): static
    {
        ...
        if ((mb_strlen($start_date) < 1)) {
            throw new InvalidArgumentException('invalid length for $start_date when calling WhenAnyOf2., must be bigger than or equal to 1.');
        }
