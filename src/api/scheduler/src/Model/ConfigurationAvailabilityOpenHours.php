<?php
/**
 * ConfigurationAvailabilityOpenHours
 *
 * PHP version 8.1
 *
...
/**
 * ConfigurationAvailabilityOpenHours Class Doc Comment
 *
 * @description 
 * @package  JackWH\NylasV3\Scheduler
 * @author   OpenAPI Generator team
 ...
 */
class ConfigurationAvailabilityOpenHours implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'configuration_availability_open_hours';
    ...
    */
     ...
     * Sets days
     *
     * @param int[]|null $days The days of the week that the open hour settings are applied to. Sunday corresponds to `0`, and Saturday corresponds to `6`.
     *
     * @return $this
     */
     ...
     * Sets start
     *
     * @param string|null $start The start time in 24-hour time format. Single-digit hours doesn't have a leading zero. The earliest start time is `0:00`, and the latest start time is `23:49`.
     *
     * @return $this
     */
    public function setStart(?string $start): static
    {
        ...
        if ((mb_strlen($start) < 1)) {
            throw new InvalidArgumentException('invalid length for $start when calling ConfigurationAvailabilityOpenHours., must be bigger than or equal to 1.');
        }
     ...
     * Sets end
     *
     * @param string|null $end The end time in a 24-hour time format. Single-digit hours doesn't have a leading zero.
     *
     * @return $this
     */
    public function setEnd(?string $end): static
    {
        ...
        if ((mb_strlen($end) < 1)) {
            throw new InvalidArgumentException('invalid length for $end when calling ConfigurationAvailabilityOpenHours., must be bigger than or equal to 1.');
        }
     ...
     * Sets exdates
     *
     * @param string[]|null $exdates A list of dates that are excluded from the open hours. Dates should be formatted as `YYYY-MM-DD`.
     *
     * @return $this
     */
