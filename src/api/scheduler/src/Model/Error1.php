...
class Error1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Gets error
     *
     * @return \JackWH\NylasV3\Scheduler\Model\Error1Error|null
     */
    public function getError(): ?\JackWH\NylasV3\Scheduler\Model\Error1Error
    {
     ...
     * Sets error
     *
     * @param \JackWH\NylasV3\Scheduler\Model\Error1Error|null $error error
     *
     * @return $this
     */
    public function setError(?\JackWH\NylasV3\Scheduler\Model\Error1Error $error): static
    {
        if (is_null($error)) {
