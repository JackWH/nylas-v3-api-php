<?php
/**
 * GetAvailability200ResponseAllOfData
 *
 * PHP version 8.1
 *
...
/**
 * GetAvailability200ResponseAllOfData Class Doc Comment
 *
 * @package  JackWH\NylasV3\Scheduler
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetAvailability200ResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_availability_200_response_allOf_data';
    ...
    protected static array $openAPITypes = [
        'order' => 'string[]',
        'time_slots' => '\JackWH\NylasV3\Scheduler\Model\TimeSlot[]',
    ];
    ...
    */
     ...
     * Gets time_slots
     *
     * @return \JackWH\NylasV3\Scheduler\Model\TimeSlot[]|null
     */
     ...
     * Sets time_slots
     *
     * @param \JackWH\NylasV3\Scheduler\Model\TimeSlot[]|null $time_slots An array of the available time slots when you can create a meeting using the requested settings.
     *
     * @return $this
     */
