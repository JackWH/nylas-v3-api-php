<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerAvailabilityAvailabilityRules
 *
 * PHP version 8.1
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerAvailabilityAvailabilityRules implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_availability_availability_rules';
    ...
    {
        $this->setIfExists('availability_method', $data ?? [], 'collective');
    ...
    */
     ...
     *
     * @param string|null $availability_method The method that Nylas uses to calculate availability for all participants. For one-on-one meetings, the `availability_method` is always `collective`.
     *
     * @return $this
     */
     ...
     * Gets buffer
     *
     * @return \JackWH\NylasV3\Scheduler\Model\Buffer|null
     */
    public function getBuffer(): ?\JackWH\NylasV3\Scheduler\Model\Buffer
    {
     ...
     * Sets buffer
     *
     * @param \JackWH\NylasV3\Scheduler\Model\Buffer|null $buffer buffer
     *
     * @return $this
     */
    public function setBuffer(?\JackWH\NylasV3\Scheduler\Model\Buffer $buffer): static
    {
        if (is_null($buffer)) {
     ...
     *
     * @return \JackWH\NylasV3\Scheduler\Model\OpenHours[]|null
     */
     ...
     *
     * @param \JackWH\NylasV3\Scheduler\Model\OpenHours[]|null $default_open_hours A default set of open hours to apply to all participants. You can overwrite these open hours for individual participants by specifying `open_hours` on the participant object.
     *
     * @return $this
     */
