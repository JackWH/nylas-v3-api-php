<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerEventBooking
 *
 * PHP version 8.1
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerEventBooking implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_event_booking';
    ...
    */
    ...
    public function setTimezone(?string $timezone): static
    {
        ...
        if ((mb_strlen($timezone) < 1)) {
            throw new InvalidArgumentException('invalid length for $timezone when calling GetConfigurations200ResponseAllOfDataInnerEventBooking., must be bigger than or equal to 1.');
        }
