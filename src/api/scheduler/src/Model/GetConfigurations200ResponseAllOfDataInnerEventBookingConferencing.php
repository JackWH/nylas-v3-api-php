<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerEventBookingConferencing
 *
 * PHP version 8.1
 *
...
/**
 * GetConfigurations200ResponseAllOfDataInnerEventBookingConferencing Class Doc Comment
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerEventBookingConferencing implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_event_booking_conferencing';
    ...
    */
    ...
    public function setProvider(?string $provider): static
    {
        ...
        if ((mb_strlen($provider) < 1)) {
            throw new InvalidArgumentException('invalid length for $provider when calling GetConfigurations200ResponseAllOfDataInnerEventBookingConferencing., must be bigger than or equal to 1.');
        }
