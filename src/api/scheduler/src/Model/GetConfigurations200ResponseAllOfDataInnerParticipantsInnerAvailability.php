<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerParticipantsInnerAvailability
 *
 * PHP version 8.1
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerParticipantsInnerAvailability implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_participants_inner_availability';
    ...
    */
     ...
     * Sets calendar_ids
     *
     * @param string[] $calendar_ids A list of calendar IDs associated with the participant's email address. These calendars are used to check the participant's availability.
     *
     * @return $this
     */
     ...
     * Sets open_hours
     *
     * @param \JackWH\NylasV3\Scheduler\Model\OpenHours[]|null $open_hours An array of objects for the participant's open hours. Nylas searches for free time slots within these open hours.
     *
     * @return $this
     */
