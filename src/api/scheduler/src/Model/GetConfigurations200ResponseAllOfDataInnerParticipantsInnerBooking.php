<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerParticipantsInnerBooking
 *
 * PHP version 8.1
 *
...
/**
 * GetConfigurations200ResponseAllOfDataInnerParticipantsInnerBooking Class Doc Comment
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerParticipantsInnerBooking implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_participants_inner_booking';
    ...
    */
     ...
     * Sets calendar_id
     *
     * @param string $calendar_id The calendar ID that the event is created in.
     *
     * @return $this
     */
