<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerSchedulerAdditionalFieldsValue
 *
 * PHP version 8.1
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerSchedulerAdditionalFieldsValue implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_scheduler_additional_fields_value';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The text label to be displayed in the Scheduler UI.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The field type. Supported values are `text`, `multi_line_text`, `email`, `phone_number`, `dropdown`, `date`, `checkbox`, and `radio_button`.
     *
     * @return $this
     */
     ...
     * Sets required
     *
     * @param bool $required Whether the field is required to be filled out by the guest when booking an event.
     *
     * @return $this
     */
     ...
     * Sets pattern
     *
     * @param string|null $pattern A regular expression pattern that the value of the field must match.
     *
     * @return $this
     */
     ...
     * Sets order
     *
     * @param int|null $order The order in which the field will be displayed in the Scheduler UI. Fields with lower order values will be displayed first.
     *
     * @return $this
     */
     ...
     * Sets options
     *
     * @param string[]|null $options A list of options for the `dropdown` or `radio_button` types. This field is required for the `dropdown` and `radio_button` types.
     *
     * @return $this
     */
