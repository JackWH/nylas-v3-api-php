<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplate
 *
 * PHP version 8.1
 *
...
/**
 * GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplate Class Doc Comment
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_scheduler_email_template';
    ...
    protected static array $openAPITypes = [
        'logo' => 'string',
        'booking_confirmed' => '\JackWH\NylasV3\Scheduler\Model\GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('booking_confirmed', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets logo
     *
     * @param string|null $logo The URL to a custom logo that appears at the top of the booking email. Replaces the default Nylas logo. The URL must be publicly accessible.
     *
     * @return $this
     */
     ...
     *
     * @return \JackWH\NylasV3\Scheduler\Model\GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed|null
     */
    public function getBookingConfirmed(): ?\JackWH\NylasV3\Scheduler\Model\GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed
    {
     ...
     *
     * @param \JackWH\NylasV3\Scheduler\Model\GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed|null $booking_confirmed booking_confirmed
     *
     * @return $this
     */
    public function setBookingConfirmed(?\JackWH\NylasV3\Scheduler\Model\GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed $booking_confirmed): static
    {
        if (is_null($booking_confirmed)) {
            throw new InvalidArgumentException('non-nullable booking_confirmed cannot be null');
        }
