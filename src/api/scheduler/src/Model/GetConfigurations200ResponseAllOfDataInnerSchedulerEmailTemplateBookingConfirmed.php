<?php
/**
 * GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed
 *
 * PHP version 8.1
 *
...
/**
 * GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed Class Doc Comment
 *
 ...
 */
class GetConfigurations200ResponseAllOfDataInnerSchedulerEmailTemplateBookingConfirmed implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_configurations_200_response_allOf_data_inner_scheduler_email_template_booking_confirmed';
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title The title to replace the default 'Booking Confirmed' title. This doesn't change the email subject line. Only visible in emails sent to guests.
     *
     * @return $this
     */
     ...
     * Sets body
     *
     * @param string|null $body The additional body to be appended after the default body. Only visible in emails sent to guests.
     *
     * @return $this
     */
