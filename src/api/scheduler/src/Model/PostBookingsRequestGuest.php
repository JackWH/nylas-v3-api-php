...
/**
 * PostBookingsRequestGuest Class Doc Comment
 *
 ...
 */
class PostBookingsRequestGuest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_bookings_request_guest';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email The guest's email address.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The guest's name.
     *
     * @return $this
     */
